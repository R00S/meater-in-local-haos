...
Last Change: v0.10.1.1 - fix(android): tip/ambient temperature divisor was /32, must be /16 per meater.yaml — boiling water tip was reading half real value
...
#   2. HERE (__init__.py)    → __version__ = "0.10.1.1"
