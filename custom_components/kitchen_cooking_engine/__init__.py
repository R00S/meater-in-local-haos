...
Last Change: v0.8.2.40 - Fix protein badge area depopulation and cut-highlight regression from v0.8.2.36
...
#   2. HERE (__init__.py)    → __version__ = "0.8.2.40"
