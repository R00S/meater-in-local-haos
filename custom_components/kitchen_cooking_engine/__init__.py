...
Last Change: v0.10.1.6 - feat(recipes): add oily fish cut files (herring, Baltic herring, mackerel) with pan_fry/grill/oven_bake method leaves
...
#   2. HERE (__init__.py)    → __version__ = "0.10.1.6"
