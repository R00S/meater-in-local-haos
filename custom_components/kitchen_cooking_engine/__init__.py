...
Last Change: v0.8.2.36 - Fix protein tree badge: add name-based subcat inference for cuisine files with file-specific protein IDs
...
#   2. HERE (__init__.py)    → __version__ = "0.8.2.36"
