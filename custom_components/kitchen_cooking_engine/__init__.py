...
Last Change: v0.8.2.41 - Fix cut-badge highlights for cuisines using file-scoped protein IDs via base_id field
...
#   2. HERE (__init__.py)    → __version__ = "0.8.2.41"
