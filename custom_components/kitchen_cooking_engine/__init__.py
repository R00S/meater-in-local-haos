...
Last Updated: 30 Apr 2026, 08:54 UTC
Last Change: v0.8.1.3 - fix: restore missing _renderIngredientCheckbox method header (blank panel / custom element not found)
...
#   2. HERE (__init__.py)    → __version__ = "0.8.1.3"
