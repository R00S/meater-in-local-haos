...
Last Change: v0.8.2.39 - Fix swedish.md: remove 23 within-section grade dupes, fix 11 non-English names, add 3 missing floor items
...
#   2. HERE (__init__.py)    → __version__ = "0.8.2.39"
