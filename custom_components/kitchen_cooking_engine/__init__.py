...
Last Change: v0.8.2.38 - Fix tooltip regression: show best available notes regardless of GUI language
...
#   2. HERE (__init__.py)    → __version__ = "0.8.2.38"
