...
Last Change: v0.10.0.6 - Android language toggle: full EN/SV switching across all native UI; bilingual cut names stored in session
...
#   2. HERE (__init__.py)    → __version__ = "0.10.0.6"
