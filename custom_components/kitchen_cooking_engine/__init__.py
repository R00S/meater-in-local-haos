...
Last Change: v0.8.2.6 - remove ha-card wrapper from cuisine region selector (was added as failed fix, made no difference)
...
#   2. HERE (__init__.py)    → __version__ = "0.8.2.6"
