...
BEEF_ROASTS = [
    ...
    # Additional roasts from frontend merge
    MeatCut(
        id=127,
        name="rump",
        name_long="Rump",
...
# Additional fish cuts from frontend merge
FISH_ADDITIONAL = [
    MeatCut(
        id=402,
        name="salmon_steak_alt",
        name_long="Steak",
        cut_order=10,
        estimated_thickness_mm=25,
        usda_safe_c=63,
    ...
    MeatCut(
        id=509,
        name="arctic_char_fillet",
        name_long="Arctic Char Fillet",
        cut_order=23,
        estimated_thickness_mm=20,
        usda_safe_c=63,
        usda_safe_f=145,
...
VENISON = [
    ...
    # Additional venison cuts from frontend merge
    MeatCut(
        id=603,
        name="venison_leg",
        name_long="Leg",
...
REINDEER = [
    ...
    # Additional reindeer cut from frontend merge
    MeatCut(
        id=612,
        name="reindeer_loin",
        name_long="Loin",
...
BUFFALO = [
    ...
    # Additional buffalo cut from frontend merge
    MeatCut(
        id=632,
        name="buffalo_burger",
        name_long="Burger",
...
MUTTON = [
    ...
    # Additional mutton cut from frontend merge
    MeatCut(
        id=652,
        name="mutton_shoulder_alt",
        name_long="Shoulder",
        cut_order=4,
        estimated_thickness_mm=100,
        usda_safe_c=63,
    ...
    MeatCategory(
        ...
        meats=[
            ...
            Meat(
                id=35,
                name="quail",
                description="Quail cuts",
                cut_types=[
                    CutType(id=355, name="Quail", cuts=QUAIL),
                ],
            ),
        ],
    ),
