...
NINJA_COMBI_RECIPES = [
    ...
    # Convection mode recipe (roast)
    NinjaCombiRecipe(
        id=1016,
        name="Classic Roasted Potatoes",
        description="Crispy outside, fluffy inside potatoes",
        mode=NinjaCombiMode.CONVECTION,
        tray_position=TrayPosition.MIDDLE,
        phases=[
            CookingPhase(
                ...
                temperature_f=392,
                duration_minutes=45,
                description="Roast until golden and crispy",
                steam_enabled=False,
            ),
        ],
        use_probe=False,
        ...
        instructions=[
            "Peel and cut potatoes into 4cm chunks",
            "Parboil in salted water for 8 minutes",
            "Drain well and shake in colander to rough up edges",
            "Let steam dry for 5 minutes",
            "Preheat oven to 200°C in Convection mode",
            "Toss potatoes with oil, garlic, rosemary, salt, and pepper",
            "Spread in single layer on baking tray",
            "Place on middle rack",
            "Roast 45 minutes, turning once halfway",
            "Potatoes should be golden and crispy",
        ],
        prep_time_minutes=20,
        ...
        difficulty="easy",
        tips=[
            "Roughing up edges creates more surface area for crisping",
            "Don't overcrowd pan - use two trays if needed",
            "Duck fat makes them extra crispy but oil works great",
