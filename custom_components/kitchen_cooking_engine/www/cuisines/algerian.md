...
- {id: turkey_bulk, grade: bulk, rating: 7, name: "Turkey", name_sv: "Kalkon", notes: "dinde; consumed in Algeria especially for celebrations; distinct from chicken; turkey tagine and roast turkey for family feasts; widely available in Algerian supermarkets and butcher shops; a growing protein category especially in urban Algeria for holiday meals"}
...
- {id: lamb_offal_bulk, grade: bulk, rating: 8, name: "Lamb offal", name_sv: "Lamminkråm", notes: "douara; tripe and organ meats; used in the popular Algerian street stew douara cooked in harissa-spiced tomato sauce; widely consumed especially during Eid al-Adha; distinct from whole lamb; a high-volume protein from traditional butchery and celebration cooking"}
- {id: cuttlefish_bulk, grade: bulk, rating: 7, name: "Cuttlefish", name_sv: "Bläckfisk", notes: "seiche; widely eaten in Algerian coastal cities (Oran, Annaba, Algiers); used in inkfish rice, stuffed preparations, and grilled; a distinct Mediterranean seafood caught year-round in the Algerian sea; different from sardines and anchovies in flavor and cooking method"}
- {id: octopus_bulk, grade: bulk, rating: 6, name: "Octopus", name_sv: "Bläckfisk", notes: "pieuvre/poulpe; used in Algerian coastal cities (Oran, Annaba, Algiers) for grilled octopus dishes and stews; caught in Mediterranean waters; a distinct large seafood protein not yet listed; used marinated and grilled or braised slowly with tomatoes and paprika"}
- {id: split_peas_bulk, grade: bulk, rating: 7, name: "Split peas", name_sv: "Delade ärtor", notes: "pois cassés; used in Algerian thick winter soups (potage aux pois cassés); distinct from lentils and chickpeas; a common dry pulse in Algerian household pantries; cooked slowly with smoked meats and vegetables; widely sold in Algerian supermarkets in 1kg bags"}
...
- {id: local_goat, grade: local, rating: 8, name: "Goat", name_sv: "Get", notes: "Raised extensively in arid and semi-arid regions of Algeria; valued for milk, meat, and hides; well-adapted to the harsh plateau and Saharan conditions"}
...
- {id: local_chicken, grade: local, rating: 5, name: "Broiler Chicken", name_sv: "Broilerkyckling", notes: "Algeria has a large domestic poultry industry supplying both broilers and laying hens; key contributor to meat and egg supply"}
...
- {id: sweet_melon_bulk, grade: bulk, rating: 7, name: "Sweet melon", name_sv: "Melon", notes: "melon jaune; grown in the Sahara and Tell region; a hugely popular summer fruit in Algeria; the yellow Algerian melon is distinct from watermelon in sweetness, texture and color; widely sold in street markets; a high-volume summer seasonal produce item"}
- {id: semolina_bulk, grade: bulk, rating: 9, name: "Semolina", name_sv: "Durumvete semolina", notes: "Semoule; durum wheat semolina; the foundational grain of Algerian cuisine; Algeria is the world's #1 couscous consumer; used for couscous, kesra flatbread, chakhchoukha, and pastries; Algeria imports ~10M tonnes wheat annually to maintain supply; consumed at virtually every meal in some form"}
- {id: spring_onion_bulk, grade: bulk, rating: 7, name: "Spring onion", name_sv: "Salladslök", notes: "ciboule printanière; fresh green onion/scallion; distinct from dry onions; used fresh in Algerian salads, tabouleh, and as a garnish; widely sold in bunches in all Algerian markets year-round; a different product from the bulb onion in the local section; adds a fresh mild bite to salads"}
- {id: clementine_bulk, grade: bulk, rating: 7, name: "Clementine", name_sv: "Klementin", notes: "clémentine; grown in the Mitidja plain near Blida (self-proclaimed capital of Algerian citrus); among the sweetest clementines in the Mediterranean; a high-volume winter citrus consumed domestically and exported; distinct from regular oranges; the peak Algerian clementine season is November–February"}
...
- {id: cauliflower_bulk, grade: bulk, rating: 7, name: "Cauliflower", name_sv: "Blomkål", notes: "chou-fleur; grown across northern Algerian coastal plain; used in Algerian couscous vegetable medley and roasted dishes; a common autumn/winter vegetable sold in all Algerian markets; a popular and affordable seasonal produce item not yet listed in any produce section"}
- {id: peaches_bulk, grade: bulk, rating: 7, name: "Peaches", name_sv: "Persikor", notes: "khokh; grown in Medea, Blida, and Batna regions in the Tell Atlas; a popular summer stone fruit consumed fresh; widely sold in Algerian markets from June to September; a distinct produce item not yet listed in any section; high volume summer seasonal consumption"}

### Produce — Local
<!-- Research strategy: What is produced, grown, farmed, fished, hunted, or foraged in this cuisine's home region. The origin story, not the consumption volume. -->
<!-- Searched: "Algeria agriculture crops grown vegetables fruits locally produced FAO" -->

- {id: prickly_pear_local, grade: local, rating: 8, name: "Prickly pear", name_sv: "Kaktusböna", notes: "kermouss el hmar; barbary fig; Opuntia ficus-indica; grows wild and cultivated throughout Algeria; the bright magenta or yellow fruit consumed fresh in summer; juice sold in street markets; a ubiquitous Algerian local fruit with deep cultural roots; prickly pear cactus visible on every Algerian roadside"}
...
- {id: pomegranate_local, grade: local, rating: 7, name: "Pomegranate", name_sv: "Granatäpple", notes: "roman/grenade; grown in Kabylie (Tizi-Ouzou) and northern Algeria; a rich, tart fruit used for juice and seed garnish; a traditional autumn fruit in Algerian household diets; not yet listed in any produce section; the pomegranate is also a motif of Algerian art and symbolism"}
...
- {id: corn_flour_grain, grade: bulk, rating: 7, name: "Corn flour", name_sv: "Majsmjöl", notes: "farine de maïs; used for Algerian griddle cakes (matlou style) and some Saharan flatbreads; also used to thicken soups; distinct from durum semolina and wheat flour in both texture and flavor; a growing supermarket product in Algerian households especially in the south"}
- {id: bulgur_grain, grade: bulk, rating: 6, name: "Bulgur", name_sv: "Bulgur", notes: "boulghour; parboiled cracked wheat; used in some east Algerian stews and tabouleh-like salads, particularly near the Tunisian border; available in Algerian markets; a distinct grain from cracked wheat (frik) due to its parboiled and dried preparation method; adds a nutty, chewy texture to salads and sides"}
...
- {id: chickpea_flour_grain, grade: bulk, rating: 7, name: "Chickpea flour", name_sv: "Kikärtsmjöl", notes: "farine de pois chiche; used in karantita (garantita), the popular Algerian street food chickpea flan; sold by street vendors in all Algerian cities, especially in Oran; a distinct grain product separate from whole chickpeas; gives a custardy texture when baked; a staple Algerian street-food ingredient"}
...
- {id: wheat_berries_grain, grade: bulk, rating: 6, name: "Wheat berries", name_sv: "Vetekärnor", notes: "blé dur entier/blé concassé; whole or cracked durum wheat; used in Algerian hearty soups (chorba) and some traditional winter preparations; distinct from semolina, flour, and frik in its whole-grain unprocessed form; a traditional ingredient in peasant cooking across northern Algeria"}
...
- {id: fava_beans_foul_local, grade: local, rating: 6, name: "Fava beans", name_sv: "Bondbönor", notes: "Foul; Vicia faba; widely grown across northern Algeria as a winter legume; used in regional soups (harira-style), as a vegetable side (foul mdhammer), and in traditional Berber stews; Algeria is among North Africa's significant fava bean producers; a traditional protein source alongside chickpeas in Algerian rural cooking"}
...
- {id: plain_yogurt_bulk, grade: bulk, rating: 8, name: "Plain yogurt", name_sv: "Naturell yoghurt", notes: "yaourt nature; commercially produced by Danone Algeria and local brands (Soummam); distinct from traditional lben and raïb in its modern industrial production process; a high-volume modern dairy product in Algerian supermarkets; consumed daily for breakfast and as snacks"}
...
- {id: condensed_milk_bulk, grade: bulk, rating: 7, name: "Condensed milk", name_sv: "Kondenserad mjölk", notes: "lait concentré sucré; Nestlé Rajab and similar brands; used in Algerian desserts, pastry glazes, and sweetened tea or coffee; very widely consumed; a distinct dairy product from fluid milk and fresh dairy; a standard Algerian pantry item bought in tubes and cans"}
- {id: soybean_oil_bulk, grade: bulk, rating: 7, name: "Soybean oil", name_sv: "Sojaolja", notes: "huile de soja; imported; widely used in Algerian industrial cooking and street food; a distinct vegetable oil separate from olive oil and the generic refined vegetable oil; commonly used in frying merguez and making industrial sauces; a significant import product in Algerian food processing"}
...
- {id: sheep_ricotta_local, grade: local, rating: 7, name: "Sheep's milk ricotta", name_sv: "Fårmjölksricotta", notes: "iguiwane; whey cheese made after pressing jben from sheep milk; a byproduct of Kabyle traditional cheese-making; fresh, mild and grainy texture; used as a spread or eaten with honey; a distinct local dairy byproduct from Kabylie artisan production not listed in any other section"}
- {id: argan_oil_local, grade: local, rating: 6, name: "Argan oil", name_sv: "Arganolja", notes: "huile d'argan; produced in small quantities in western Algeria near the Moroccan border (Tlemcen region); used for culinary purposes as a finishing drizzle and for preparing amlou-style preparations; a rare and expensive Algerian local oil distinct from olive oil and all other oils listed"}
- {id: date_paste_local, grade: local, rating: 7, name: "Date paste", name_sv: "Dadelpasta", notes: "pâte de dattes; made from surplus dates pressed into blocks; used as a natural sweetener, filling for makroud and other pastries, and as a spread; a distinct Algerian preserved product made from the abundant Deglet Nour and Degla Beida harvest; not the same as fresh dates or date syrup"}
- {id: raw_sheep_milk_local, grade: local, rating: 7, name: "Raw sheep's milk", name_sv: "Rå fårmjölk", notes: "lait de brebis cru; unpasteurized full-fat milk from Ouled Djellal and other Algerian sheep breeds; the raw material for jben and smen production; sold directly from farms in rural areas; a distinct artisan dairy product with rich fat and protein; used fresh or left to sour naturally for home cheese-making"}
...
- {id: nigella_seeds_bulk, grade: bulk, rating: 6, name: "Nigella seeds", name_sv: "Svartkummin", notes: "habba sawda; habbat el baraka; the blessed black seed; sprinkled on kesra bread and flatbreads; used in some Algerian meat marinades; not yet listed in any spice section; also consumed as a health supplement in Algerian households; a distinct seed spice with earthy, slightly bitter flavour"}
...
- {id: turmeric_spice, grade: bulk, rating: 7, name: "Turmeric", name_sv: "Gurkmeja", notes: "kurkum; safran des indes; a standard spice in Algerian chermoula marinades, chicken preparations, and some tagines; sold in all Algerian spice stalls; gives a golden color to sauces and rice; a widely used everyday spice not yet listed in any Algerian spice section"}
- {id: fenugreek_bulk, grade: bulk, rating: 6, name: "Fenugreek", name_sv: "Bockhornsklöver", notes: "helba; Trigonella foenum-graecum; used as a spice in some Algerian meat preparations and flatbreads; sold in all Algerian spice markets; a distinct spice with bitter, maple-like aroma not yet listed in any section; also used medicinally and as a tea"}
...
- {id: pistachios_bulk, grade: bulk, rating: 6, name: "Pistachios", name_sv: "Pistaschnötter", notes: "fustuq; grown in Beni Snous region in Tlemcen and in limited quantities across northern Algeria; used in Algerian pastries, makroud fillings, and baklava; a distinct nut separate from kabyle almonds; a premium local nut product used in Algerian traditional confectionery"}
...
- {id: anise_seed_bulk, grade: bulk, rating: 7, name: "Anise seed", name_sv: "Anisfrön", notes: "hab hloua/anis; used in Algerian ring cookies (kaab el ghzal), bread flavoring (khobz anise), and digestive teas; widely available in Algerian spice markets; a distinct Algerian baking spice not yet listed in any section; also infused as a after-meal digestif tea"}
