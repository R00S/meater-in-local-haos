...
region_icon: 🦅
description: "Canadian cuisine reflects the country's vast regional diversity — from Quebec's French-rooted comfort food (poutine, tourtière) to Maritime lobster suppers, Prairie beef and grain traditions, BC Pacific salmon, and Indigenous staples like wild rice, bannock, and bison. Maple syrup from Quebec (72% of world supply) is the defining flavour of Canadian identity."
description_sv: "Kanadensiskt kök speglar landets stora regionala mångfald — från Quebecs franskinfluerade husmanskost (poutine, tourtière) till Maritimes hummerkalas, Präriens nötkött och spannmål, BC:s Stillahavsaxel och ursprungsfolkens basmat som vildris, bannock och bison. Lönnsirap från Quebec (72% av världsproduktionen) är den definerande smaken i kanadensisk identitet."
research_done: 1
---

## Research notes

Sources: Agriculture and Agri-Food Canada; Statistics Canada; Fisheries and Oceans Canada Fast Facts 2024;
Canada Beef Fast Facts 2025; Canola Council of Canada; PPAQ (maple syrup producers); Statistics Canada
Table 32-10-0054-01; DFO Aquaculture 2023; Statistics Canada mustard seed report.

Key figures used:
- Chicken: 35.35 kg/capita (Ag Canada 2022), Pork: 19.99 kg/capita, Beef: 17.5 kg/capita
- Quebec produces ~72% of world maple syrup (PPAQ 2024-25)
- Canada: world #3 wheat exporter (35M tonnes 2024), world #1 canola producer (21.8M tonnes 2025)
- Atlantic lobster: highest-value fishery, CAD $2.8B shellfish (DFO 2023)
- Alberta: ~43% of national cattle herd (10.9M head, Jan 2025)
- Canada dairy: 15.3 kg cheese/capita, 3.8 kg butter/capita, 58.7L fluid milk/capita (2023)
- Canada: world #1 mustard seed exporter, 192K tonnes harvested 2024 (Saskatchewan 75%)
- Wild blueberries: NS/NB — Atlantic Canada world's largest wild blueberry region
- PEI: 20.4% of Canada's record 127M hundredweight potato crop (2024)


## Proteins

### Proteins — Signature
<!-- Iconic proteins that define Canadian culinary identity coast to coast. -->
...
### Proteins — Bulk
<!-- Highest statistical consumption by volume, kg/capita — Agriculture and Agri-Food Canada 2022. -->

- {id: can_prot_bul_chicken, grade: bulk, rating: 9, name: "Chicken", name_sv: "Kyckling", notes: "35.35 kg/capita 2022 — highest meat consumption in Canada (Agriculture and Agri-Food Canada protein disappearance data)"}
- {id: can_prot_bul_pork, grade: bulk, rating: 8, name: "Pork", name_sv: "Fläsk", notes: "19.99 kg/capita 2022 — #2 most consumed meat; includes processed ham, sausage, and back bacon (Ag Canada)"}
- {id: can_prot_bul_beef, grade: bulk, rating: 7, name: "Beef", name_sv: "Nötkött", notes: "17.5 kg/capita 2022 (retail weight) — #3; beef and veal production 1.28M tonnes in 2024 (Ag Canada)"}
- {id: can_prot_bul_eggs, grade: bulk, rating: 6, name: "Eggs", name_sv: "Ägg", notes: "Major protein staple; Canadian Egg Farmers report ~20 eggs/month per Canadian household; breakfast staple nationwide"}
...
- {id: can_prot_loc_pei_oyster, grade: local, rating: 9, name: "PEI Oyster", name_sv: "PEI-ostron", notes: "Crassostrea virginica; Prince Edward Island and New Brunswick top oyster-farming provinces; cold clean Atlantic waters produce world-class oysters; PEI oysters exported to USA, Japan, EU; part of Atlantic Canada's CAD $2.8B shellfish sector (DFO 2023)"}
...
### Produce — Signature
<!-- Iconic produce that defines Canadian regional and national food identity. -->
...
### Produce — Bulk
<!-- Highest statistical consumption by volume — Statistics Canada, Agriculture and Agri-Food Canada. -->

- {id: can_prod_bul_potato, grade: bulk, rating: 9, name: "Potato", name_sv: "Potatis", notes: "Canada's #1 vegetable; 26% of all vegetable receipts; 127M hundredweight production record in 2024 (Statistics Canada)"}
- {id: can_prod_bul_tomato, grade: bulk, rating: 8, name: "Tomato", name_sv: "Tomat", notes: "Greenhouse tomatoes dominant (Ontario/BC); 96% of greenhouse veg are tomatoes/peppers/cucumbers (Ag Canada FVGC stats)"}
- {id: can_prod_bul_carrot, grade: bulk, rating: 7, name: "Carrot", name_sv: "Morot", notes: "Among top field vegetables by farm-gate value; grown primarily in Ontario and Quebec; consumed year-round across Canada"}
- {id: can_prod_bul_onion, grade: bulk, rating: 6, name: "Onion", name_sv: "Lök", notes: "Dry onions among top field vegetables by production value; grown in Alberta and Ontario; used in virtually all Canadian cooking"}
- {id: can_prod_bul_apple, grade: bulk, rating: 6, name: "Apple", name_sv: "Äpple", notes: "Most produced and consumed domestic fruit; BC Okanagan and Ontario Niagara major orchards; 37.2 kg/capita fruit 2021 (Stats Can)"}
- {id: can_prod_bul_banana, grade: bulk, rating: 5, name: "Banana", name_sv: "Banan", notes: "Most consumed fruit by volume (imported); ubiquitous in Canadian households; higher per capita consumption than any local fruit"}
- {id: can_prod_bul_cucumber, grade: bulk, rating: 4, name: "Cucumber", name_sv: "Gurka", notes: "Part of dominant greenhouse trio (tomato/pepper/cucumber); Ontario leads production; consumed year-round in salads"}
- {id: can_prod_bul_bell_pepper, grade: bulk, rating: 3, name: "Bell Pepper", name_sv: "Paprika", notes: "Greenhouse grown in Ontario/BC; among top 3 greenhouse vegetables; high volume in Canadian kitchens (FVGC statistics)"}
- {id: can_prod_bul_strawberry, grade: bulk, rating: 2, name: "Strawberry", name_sv: "Jordgubbe", notes: "Most consumed berry; grown in Quebec, Ontario, BC; summer pick-your-own culture is a Canadian seasonal institution"}

### Produce — Local
<!-- Grown, harvested, or foraged specifically within Canada. -->
...
- {id: can_prod_loc_okanagan_cherry, grade: local, rating: 8, name: "Okanagan cherry", name_sv: "Okanagankörsbar", notes: "BC Okanagan Valley is Canada's prime sweet cherry region; Bing, Rainier, Lapins varieties; Canada exports ~20,000 MT sweet cherries annually, ~95% from BC; exported to Asia and USA; BC Tree Fruits Co-op (Kelowna) major processor"}
...
- {id: can_prod_loc_haskap_berry, grade: local, rating: 6, name: "Haskap berry", name_sv: "Haskapbär", notes: "blue honeysuckle; Lonicera caerulea; native to Canadian boreal forest; commercially grown in Saskatchewan and Manitoba; tart antioxidant-rich berry used in jams, wines, and baking; rapidly growing Canadian fruit industry with ~1,000+ ha under cultivation"}
...
- {id: can_grain_bul_wheat_flour_bread, grade: bulk, rating: 9, name: "Wheat flour", name_sv: "Vetemjöl", notes: "also white bread; dominant grain product; Canadian 35M tonne 2024 domestic wheat harvest (Cereals Canada); Dominant grain product; Canadian bread consumption underpinned by 35M tonne 2024 domestic wheat harvest (Cereals Canada)"}
...
- {id: can_grain_bul_potato_starch, grade: bulk, rating: 6, name: "Potato starch", name_sv: "Potatisstärkelse", notes: "as starch/side; 26% of all vegetable receipts in Canada; boiled, mashed, fried — the most eaten starchy side dish in Canadian cuisine"}
- {id: can_grain_bul_oatmeal, grade: bulk, rating: 6, name: "Rolled oats", name_sv: "Havregryn", notes: "oatmeal; dominant Canadian breakfast grain; Prairie oats in 97% of Canadian household pantries; Dominant Canadian breakfast grain; Quaker Oats (Canadian brand heritage); Prairie oats in 97% of Canadian household pantries"}
...
- {id: can_grain_bul_split_peas, grade: bulk, rating: 4, name: "Split peas", name_sv: "Gula ärtor", notes: "pois cassés; Canada world's #1 pea exporter (SK/MB); yellow split peas used in traditional Quebec pea soup (soupe aux pois) — a national heritage dish; also in Maritime cooking and Indigenous bannock variations; ~19M MT Canadian field pea production 2022"}
...
- {id: can_grain_bul_quinoa, grade: bulk, rating: 2, name: "Quinoa", name_sv: "Quinoa", notes: "growing mainstream health grain in Canada; significant imports with small domestic production emerging in BC and Prairies; widely stocked in Canadian supermarkets; driven by health-conscious households and Indigenous whole-food diets"}
...
- {id: can_grain_loc_hemp_seed, grade: local, rating: 6, name: "Hemp seed", name_sv: "Hampafrön", notes: "food-grade hulled hemp hearts; Manitoba, Saskatchewan, Alberta; Canada is the world's largest hemp seed producer and exporter; significant growth in health food sector; rich in protein and omega fatty acids; Hemp Oil Canada and Manitoba Harvest major producers"}
...
- {id: can_dairy_sig_maple_cream, grade: signature, rating: 9, name: "Maple cream", name_sv: "Lönncreme", notes: "also maple butter; whipped pure Quebec maple syrup; iconic Canadian artisan product sold at every sugar shack; Whipped pure Quebec maple syrup; spreadable; iconic Canadian souvenir and artisan product; sold at every sugar shack (cabane à sucre)"}
...
<!-- Highest volume consumed by Canadians statistically — Statistics Canada 2022-2023. -->
...
- {id: can_dairy_bul_olive_oil, grade: bulk, rating: 8, name: "Olive oil", name_sv: "Olivolja", notes: "significant Canadian import; widely used in salads, pasta, and everyday cooking; growth driven by Mediterranean dietary influence; found in virtually every Canadian pantry alongside canola oil (Stats Can household food expenditure surveys)"}
- {id: can_dairy_bul_cream_cheese, grade: bulk, rating: 7, name: "Cream cheese", name_sv: "Färskost", notes: "widely consumed in Canada on bagels, in dips, and cheesecakes; Philadelphia brand dominant; Montreal vs New York bagel debate drives high cream cheese consumption; significant household dairy purchase across all provinces"}
...
- {id: can_dairy_bul_cream, grade: bulk, rating: 3, name: "Whipping cream", name_sv: "Vispgrädde", notes: "also heavy cream; used in chowders, soups, baking; consistent supply from Canadian dairy supply management; Baking, chowders, soups, coffee whitener; Canadian dairy supply management ensures consistent fresh supply year-round"}
- {id: can_dairy_bul_margarine, grade: bulk, rating: 2, name: "Margarine", name_sv: "Margarin", notes: "Once dominant fat; declining in favour of butter and canola oil; still significant in commercial baking and lower-income households"}
...
- {id: can_spice_sig_dulse, grade: signature, rating: 9, name: "Dulse seaweed", name_sv: "Dulse tång", notes: "Palmaria palmata; Atlantic sea vegetable harvested from New Brunswick and Nova Scotia shores; used by Mi'kmaq, Maliseet, and Acadian communities for centuries as a salty snack and seasoning; dried dulse is eaten as chips, in seafood chowder, and as a salt substitute; now a gourmet Canadian ingredient featured in fine dining; one of the few distinctly Atlantic-Canadian signature foods"}
...
- {id: can_spice_bul_coriander_seed, grade: bulk, rating: 6, name: "Coriander seed", name_sv: "Korianderfrön", notes: "widely used in Canadian pickle brines, BBQ dry rubs, and spice blends; significant bulk purchase driven by multicultural Canadian cooking (South Asian, Middle Eastern, Mexican-Canadian cuisines); Canada grows some coriander in prairies (AAFC data)"}
...
- {id: can_spice_loc_wild_garlic_ramps, grade: local, rating: 5, name: "Ramps", name_sv: "Ramps", notes: "Allium tricoccum; wild garlic; foraged in Eastern Canada (Quebec, Ontario, NB); spring seasonal; protected in Quebec; Allium tricoccum foraged in Eastern Canada (Quebec, Ontario, NB); spring seasonal; protected in Quebec under harvest quotas"}
...
- {id: can_spice_loc_fiddlehead_seasoning, grade: local, rating: 3, name: "Fiddlehead fern", name_sv: "Fiddlehead-ormbunke", notes: "Matteuccia struthiopteris; a distinctly Canadian spring forage food; young fern coils harvested from riverbanks in New Brunswick, Quebec, and Ontario; briefly boiled and served with butter; an iconic Eastern Canadian wild-harvest ingredient; sold seasonally at farmers' markets; used in some artisan seasonings as a dried ground herb"}
