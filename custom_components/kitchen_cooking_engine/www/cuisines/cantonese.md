...
- {id: stub_har_gow_shrimp, grade: signature, rating: 8, name: "[STUB] Protein", name_sv: "[UTKAST] Protein", notes: "STUB — har gow (translucent shrimp dumplings) signals shrimp — shrimp already listed as shrimp_prawn; research another Cantonese signature protein not yet listed"}
- {id: stub_white_cut_chicken, grade: signature, rating: 8, name: "[STUB] Protein (Cantonese signature)", name_sv: "[UTKAST] Protein (Cantonese signature)", notes: "STUB — white cut chicken (bai qie ji — poached free-range chicken served with ginger-scallion oil) — chicken already listed as chicken_guangdong; research another Cantonese signature protein not yet listed"}
...
- {id: shrimp_prawn, grade: bulk, rating: 7, name: "Shrimp / Prawn", name_sv: "Räkor / tigerräkor", notes: "South China Sea and Pearl River Delta shrimp farming major industry; shrimp consumed fresh, dried (har mai), and in dumplings (har gow); high daily volume at Cantonese tables"}
...
- {id: cantonese_wenchang_chicken, grade: local, rating: 6, name: "Qingyuan / Guangdong Local Chicken", name_sv: "Qingyuan / Guangdong lokal kyckling", notes: "Qingyuan chicken (清远鸡) and Huiyang bearded chicken are GI-protected Guangdong breeds; prized for flavour in white cut chicken; raised free-range in hill towns north of Pearl River"}
...
- {id: pigs_guangdong, grade: local, rating: 4, name: "Guangdong Local Pigs", name_sv: "Guangdong lokalgris", notes: "e.g. Qingping; Native Guangdong pig breeds (Qingping, Wuhua black pig) historically raised in Pearl River Delta villages; leaner than commercial breeds; prized for suckling pig roasts and char siu"}
...
- {id: daikon_white_radish, grade: signature, rating: 5, name: "Daikon / White Radish", name_sv: "Daikon / vit rädisa", notes: "Luóbo; Used in Cantonese turnip cake (lo bak gou) for dim sum; braised with pork ribs in soups; pickled as condiment; extremely high-volume ingredient in Guangdong households"}
...
- {id: bok_choy_bulk, grade: bulk, rating: 8, name: "Bok Choy / Pak Choi", name_sv: "Pak choi", notes: "market volume; Guangdong's most consumed local green vegetable by weight in wet markets; eaten daily across all household income levels; China's per capita vegetable consumption ~407 kg/yr (2022)"}
...
- {id: spring_onion_scallion, grade: bulk, rating: 6, name: "Spring Onion / Scallion", name_sv: "Vårlök / salladslök", notes: "Extremely high daily-use volume in Cantonese cooking; used raw as garnish, in ginger-scallion sauces, in stir-fries, congee toppings, and in almost every single Cantonese dish"}
- {id: garlic_guangdong, grade: bulk, rating: 5, name: "Garlic", name_sv: "Vitlök", notes: "Consumed in very high volume as the primary aromatic for wok stir-frying; Guangdong households and restaurants use garlic in virtually every vegetable and meat dish; also pickled"}
...
- {id: eggplant_guangdong, grade: bulk, rating: 4, name: "Eggplant / Aubergine", name_sv: "Aubergine", notes: "Qié Zi; Braised in clay pot with minced pork and black bean — a popular Guangdong dish; also steamed with garlic and oyster sauce; grown extensively in the province; moderate-high consumption"}
...
- {id: lotus_root_local, grade: local, rating: 7, name: "Lotus Root", name_sv: "Lotusrot", notes: "Guangdong Wetlands; Harvested from ponds and wetland fields in the Pearl River Delta; aquatic vegetable agriculture is a traditional Guangdong farming practice; key ingredient in slow-simmered soups"}
- {id: water_spinach_local, grade: local, rating: 7, name: "Water Spinach", name_sv: "Vattenspinach", notes: "Local Guangdong; Thrives in warm, wet PRD climate; grown in backyard plots and small farms throughout Guangdong; peak season April–October; among the cheapest and most accessible local vegetables"}
...
- {id: winter_melon_local, grade: local, rating: 5, name: "Winter Melon", name_sv: "Vintermelon", notes: "Guangdong Grown; Large winter melons grown widely across Guangdong; favoured in soup-focused Cantonese cooking; can reach 10-20 kg; some carved as decorative serving vessels at banquet restaurants"}
- {id: mustard_greens_local, grade: local, rating: 4, name: "Mustard Greens / Gai Choy", name_sv: "Senapsblad / gai choy", notes: "Grown year-round in Guangdong; used fresh in soups and stir-fries; also pickled as 'suancai' (sour preserved mustard greens) — a traditional Hakka/Teochew/Cantonese condiment"}
...
- {id: stub_congee_jook, grade: signature, rating: 9, name: "[STUB] Grain", name_sv: "[UTKAST] Grain", notes: "Cantonese signature; STUB — congee/jūk (rice porridge) — rice already listed as jasmine_rice; research another Cantonese grain or starch ingredient not yet listed"}
...
- {id: stub_char_siu_bao_pastry, grade: signature, rating: 6, name: "[STUB] Grain", name_sv: "[UTKAST] Grain", notes: "Cantonese signature; STUB — char siu bao (BBQ pork bun) — bun is made from wheat flour already listed; research another Cantonese grain product not yet listed"}
- {id: lo_bak_gou, grade: signature, rating: 6, name: "Turnip Cake / Lo Bak Gou", name_sv: "Rädisekaka / lo bak gou", notes: "Rice flour and grated daikon pressed into cakes and pan-fried; a classic Cantonese dim sum item and Chinese New Year food; dense, savoury, slightly crispy exterior"}
...
- {id: stub_taro_wu_gok, grade: signature, rating: 4, name: "[STUB] Grain/starch", name_sv: "[UTKAST] Grain/starch", notes: "Cantonese signature; STUB — wu gok (taro dumpling) — taro already listed as taro; research another Cantonese grain or starch ingredient not yet listed"}
...
- {id: glutinous_rice, grade: bulk, rating: 5, name: "Glutinous Rice", name_sv: "Klibbigt ris", notes: "Nuo Mi; Used for lo mai gai (lotus leaf wrapped sticky rice — a dim sum classic), zongzi (glutinous rice dumplings for Dragon Boat Festival), and new year cakes; significant seasonal volume spike"}
- {id: corn_maize, grade: bulk, rating: 4, name: "Corn / Maize", name_sv: "Majs", notes: "Increasing bulk staple in Guangdong; eaten as snack corn-on-the-cob, in soups (pork and corn sweet soup), and as cornstarch in stir-fry sauces; China's corn production and consumption growing rapidly"}
...
- {id: rice_guangdong_local, grade: local, rating: 9, name: "Guangdong Locally Grown Rice", name_sv: "Guangdong lokalodlat ris", notes: "Guangdong 2022 rice output: ~5.2 million tonnes (NBS); planting area 2.3 million ha; Pearl River Delta double-cropped paddy (early + late rice); mechanically harvested on 34.5M mu; record output in 2022"}
...
- {id: glutinous_rice_local, grade: local, rating: 6, name: "Glutinous Rice", name_sv: "Klibbigt ris", notes: "Pearl River Delta; Glutinous rice varieties grown locally in Guangdong's rice-farming areas; used in lo mai gai and zongzi; some GI-protected varieties exist in specific Guangdong counties"}
- {id: taro_cake_starch, grade: local, rating: 5, name: "Local Taro", name_sv: "Lokal taro", notes: "Taro grown in Guangdong's inland areas (Conghua, Shunde) specifically for dim sum applications; mixed with starch for honeycomb wu gok pastry; distinct starch profile from local cultivars"}
...
- {id: peanut_local, grade: local, rating: 3, name: "Peanut — Local", name_sv: "Jordnöt — lokal", notes: "Huā Shēng; Some peanut cultivation in Guangdong province though not a top national producer; peanuts used in peanut oil (primary Cantonese cooking fat), peanut butter, peanut congee, and as garnish on noodles"}
...
- {id: oyster_sauce_bulk, grade: bulk, rating: 7, name: "Oyster Sauce", name_sv: "Ostronsås", notes: "Market Volume; China dominates global oyster sauce production and consumption; Lee Kum Kee and Haitian (Guangdong brands) hold largest market shares; consumed at very high volume in Guangdong restaurants and homes daily"}
...
- {id: shaoxing_wine, grade: bulk, rating: 6, name: "Shaoxing Rice Wine", name_sv: "Shaoxing-risvin", notes: "Standard Cantonese cooking wine for marinades, steaming, and stir-fries; used in virtually every meat preparation across Guangdong; high-volume ingredient in restaurant and home cooking throughout China"}
...
- {id: sesame_paste, grade: bulk, rating: 4, name: "Sesame Paste / Tahini", name_sv: "Sesampasta / tahini", notes: "Zhī Ma Jiàng; High-volume condiment used in Cantonese cold noodles, cheung fun dipping sauce, and sesame balls (jian dui); produced in bulk across China with significant consumption in Guangdong's dim sum sector"}
- {id: chili_oil_sauce, grade: bulk, rating: 4, name: "Chili Oil / Sauce", name_sv: "Chiliolja / chilisås", notes: "Moderate use in Cantonese context (cuisine is less spicy than Sichuan/Hunan); but increasing consumption in Guangdong especially among younger consumers; high-volume Lao Gan Ma brand widely used"}
...
- {id: doubanjiang_cantonese, grade: local, rating: 6, name: "Fermented Bean Paste / Soybean Paste", name_sv: "Fermenterad bönpasta / sojabönpasta", notes: "Cantonese-style milder fermented soybean paste (vs Sichuan doubanjiang) produced locally in Guangdong; used in braised dishes and as dipping sauces; produced by local workshops using traditional ceramic jar fermentation"}
...
- {id: ginger_wine_local, grade: local, rating: 4, name: "Ginger Wine / Ginger Vinegar", name_sv: "Ingefärsvin / ingefärsvinäger", notes: "Traditional Guangdong postpartum food: pig trotters in black vinegar and ginger (zhu jiao jiang cu); ginger wine made locally for this famous Cantonese confinement dish; produced in household and small-batch traditions"}
...
- {id: spring_onion_spice, grade: signature, rating: 9, name: "Spring Onion / Scallion", name_sv: "Vårlök / salladslök", notes: "Cōng; Paired with ginger as the foundational Cantonese aromatic duo; used raw as garnish, fried into ginger-scallion oil, added to wonton filling and congee; grown throughout Guangdong year-round"}
...
- {id: sha_jiang_sand_ginger, grade: signature, rating: 4, name: "Sand Ginger / Sha Jiang", name_sv: "Sandingefära / sha jiang", notes: "Kaempferia; Distinctive Cantonese and Southeast Asian spice; dried powder used in salt-baked chicken (yan ju gai) — a celebrated Guangdong dish; smoky, camphor-like fragrance unlike regular ginger; grown in southern China"}
...
- {id: ginger_bulk, grade: bulk, rating: 8, name: "Ginger", name_sv: "Ingefära", notes: "Bulk; Second highest-volume aromatic after garlic; used in every protein preparation in Guangdong; both fresh root (daily cooking) and dried powder (medicinal teas, spice blends) consumed at very high volumes"}
- {id: soy_sauce_seasoning, grade: bulk, rating: 8, name: "Soy Sauce", name_sv: "Sojasås", notes: "Seasoning Volume; Per capita soy sauce consumption in China: ~1.2 kg/yr; Guangdong above average with massive restaurant sector; Foshan Haitian alone produces millions of tonnes; dominant daily-use liquid seasoning"}
- {id: oyster_sauce_daily, grade: bulk, rating: 7, name: "Oyster Sauce", name_sv: "Ostronsås", notes: "Daily Use; Used on vegetables, in marinades, stir-fry sauces, and as table condiment throughout Guangdong; Lee Kum Kee premium oyster sauce is the top-selling variant; very high restaurant and household daily volume"}
- {id: spring_onion_bulk, grade: bulk, rating: 6, name: "Spring Onion", name_sv: "Vårlök", notes: "Bulk Use; Among the highest-volume fresh herbs in Guangdong wet markets; used daily in almost every dish as garnish or seasoning; inexpensive, fast-growing, available year-round; dominant bulk aromatic in HK restaurant kitchens"}
...
- {id: chili_bean_paste, grade: bulk, rating: 4, name: "Chili / Spicy Condiments", name_sv: "Chili / starka kondiment", notes: "Growing Market; Though Cantonese cuisine is traditionally mild, chili sauce and hot sauce consumption growing rapidly in Guangdong especially among younger consumers; Lao Gan Ma and local brands drive volume; market growing ~15%/yr"}
...
- {id: sand_ginger_local, grade: local, rating: 6, name: "Sand Ginger — Local", name_sv: "Sandingefära — lokal", notes: "Sha Jiang; Kaempferia galanga grown in southern Guangdong and surrounding areas; powdered for salt-baked chicken spice blend; also used in Teochew and Hakka sub-cuisines within Guangdong; not exported widely"}
- {id: sesame_guangdong, grade: local, rating: 5, name: "Sesame Seeds", name_sv: "Sesamfrön", notes: "Guangdong Grown; Some sesame cultivation in Guangdong province; used locally for sesame oil pressing, dim sum sesame balls (jian dui), and sesame paste production; also imported from Henan but local production exists"}
- {id: cassia_guangdong, grade: local, rating: 5, name: "Cassia Bark / Cinnamon", name_sv: "Kassiabark / kanel", notes: "Chinese cassia (Cinnamomum cassia) grown in Guangdong and Guangxi; used in five-spice powder, master stock braises, and herbal soups; Guangdong's warm climate supports cassia cultivation; sold in dry goods markets"}
- {id: star_anise_local, grade: local, rating: 5, name: "Star Anise", name_sv: "Stjärnanis", notes: "Regional Supply; Primary production in Guangxi (bordering Guangdong) supplies the Guangdong market; some cultivation in southern Guangdong; China produces ~90% of global star anise; essential spice in all Cantonese braised and roasted meats"}
...
- {id: peanuts_snack_local, grade: local, rating: 4, name: "Peanuts — Local Use", name_sv: "Jordnötter — lokal användning", notes: "Hua Sheng; Grown in parts of Guangdong; used as garnish for congee and cold noodles, crushed as topping, in peanut candy (fall festival snack), and pressed for peanut oil in small local mills; multi-purpose culinary nut"}
- {id: white_pepper_local, grade: local, rating: 3, name: "White Pepper", name_sv: "Vit peppar", notes: "Guangdong Coast Supply; Historically grown on Hainan island (adjacent to Guangdong); some coastal Guangdong production; Guangdong traders have distributed and refined Hainan white pepper for centuries; used in wonton filling, congee, and steamed dishes"}
