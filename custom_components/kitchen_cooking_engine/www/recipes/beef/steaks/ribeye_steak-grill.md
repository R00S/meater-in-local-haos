...
**Temperature guidance (from recipe)**: Turn frequently; ideal result at medium-rare. Pull before internal temp reaches 57 °C; rest 4–5 minutes.

**Ingredients**
- 4 ribeye steaks, 200–250 g each
- Salt (1 level tsp per side) — applied 2 hours ahead
- Freshly ground pepper (added after grilling)
- A little rapeseed oil (for greasing grill grate)

**Method**
1. Season ribeye steaks generously with salt (1 level tsp per side) 2 hours before grilling.
2. Preheat gas grill (e.g. Weber Q3200) for 5–10 minutes. Turn burners down to between high and medium. Grease grill grate using kitchen paper soaked in rapeseed oil, held in tongs.
3. Lay steaks on grill. Turn every 30 seconds — constant turning gives the most even crust and a juicier result. Grill 2–3 minutes per side total (6–8 minutes total, depending on thickness).
4. Insert MEATER probe through the edge to the centre. **Pull at 52–54 °C (126–129 °F)**.
5. Add pepper after grilling (black pepper burns on a hot grill).
6. Rest on a board 4–5 minutes. Top each steak with a generous knob of butter as it rests.
7. Serve with pepper sauce and Danish spidskål salad, or oven-roasted potatoes with balsamic.
...
**Temperature guidance (from recipe)**: "Pasamos la carne por la plancha bien caliente, hasta conseguir el punto que le guste a cada uno. Aunque para una carne tan sabrosa, lo recomendable es solamente marcar." (Cook to personal preference; for such flavourful beef the recommendation is simply to mark/sear — i.e. medium-rare.)

**Ingredients**
- 1 chuletón (ribeye), thick cut, approx. 400–600 g
- 300 ml red wine (half a bottle)
...
**Method**
1. Reduce wine in a saucepan on low heat until reduced to one-third.
2. Clean and chop strawberries. Sauté briefly in a pan, blend with a hand blender, and add to the reduced wine with the sugar. Continue reducing gently. Set aside.
3. Bring ribeye to room temperature. Oil the griddle/plancha and heat until very hot.
4. Cook the steak 2–3 minutes per side over high direct heat, marking it well on each side.
5. Insert MEATER probe. **Pull at 52–54 °C (126–129 °F)** for medium-rare.
6. Add fleur de sel at the last moment (off the heat) to prevent moisture loss.
7. Optionally cube the steak and serve in tasting spoons with a drizzle of sauce, or plate whole alongside the sauce.
...
**Temperature guidance (from recipe)**: "La cottura migliore è media al sangue con temperatura al cuore di 55°–60°." (Best cooked to medium-rare with a core temperature of 55–60 °C.) Rare alternative: 50–55 °C.

**Ingredients**
- 1 thick-cut ribeye (or T-bone/Fiorentina style), about 1.2 kg, at least 3 fingers thick
- Coarse sea salt (added only after cooking)
- Extra-virgin olive oil (added after cooking)
- Oak and holm-oak charcoal (brace)

**Method**
1. Remove steak from refrigerator several hours ahead; bring to room temperature.
2. Prepare charcoal (oak/holm-oak): allow to reach maximum temperature until a light white veil forms on the coals. Position grill over.
3. Stand the steak on its bone vertically beside the coals to warm gently for a few minutes. Then lay flat at centre of grill.
4. Cook 8 minutes per side; grill lines should be clearly visible when turned. Then stand again on the bone for the final rest.
5. Insert MEATER probe from the side away from the bone. **Pull at 52–55 °C (126–131 °F)**.
6. Transfer to a chopping board; rest a few minutes. Season with salt and a drizzle of olive oil; massage in by hand.
7. Carve: cut filetto from controfiletto alongside the bone. Serve immediately, bone upright.
