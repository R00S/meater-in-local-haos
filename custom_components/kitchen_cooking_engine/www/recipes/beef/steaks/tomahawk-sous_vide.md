...
**Method**
1. Preheat sous vide water bath to **57 °C** for medium-rare.
2. Pat tomahawk dry. Season all sides with salt, pepper, garlic powder, and thyme.
3. Vacuum-seal. The bone will protrude — seal around it or use a large enough bag with bone wrapped in a cloth to avoid puncturing.
4. Submerge in bath for **3–4 hours** (3 hr for 5 cm thickness; 4 hr for 7–8 cm).
5. Remove from bag. Pat very dry — a wet surface will not sear well.
6. Heat BBQ or large cast-iron griddle to maximum. Sear tomahawk **3–4 minutes per side** for deep crust. Sear the fat edge too.
7. Insert MEATER probe to confirm sear: **surface 140–160 °C** for a few seconds; pull when crust is set. Core will hold at bath temperature.
8. Rest 5 minutes on a rack. Serve sliced 1 cm thick with butter sauce or chimichurri.
*Final core temperature: 57–60 °C (135–140 °F).*
...
**Ingredients**
- 1 tomahawk steak, 1.2–1.8 kg
- Generous coarse salt and freshly ground black pepper
- Neutral seed oil (for searing)

**Method**
1. Season tomahawk generously on all surfaces with salt and pepper. Vacuum-seal (bone-end out or with bone wrapped to protect bag).
2. Set roner to **55 °C**. Submerge and cook for **3–4 hours** (the bone and extra mass require longer than a standard ribeye).
3. Remove; pat extremely dry with kitchen paper.
4. Heat a cast-iron pan (or flat BBQ plate) to maximum heat. Add thin layer of seed oil.
5. Sear each flat surface for **60 seconds**. Sear fat cap and edges too (stand upright using tongs).
6. Insert MEATER probe. **Core should read 54–57 °C (129–135 °F)** — matching the bath.
7. No resting needed — juices are already redistributed. Slice and serve immediately.
...
**Method**
1. Pat dry tomahawk. Place in large vacuum bag with melted butter, rosemary, and garlic. Vacuum-seal. Marinate overnight in refrigerator.
2. Heat water to **60 °C**. Submerge bag (weighted down) for **2–3 hours**.
3. Remove; pour bag liquid through sieve and reserve for sauce. Pat steak very dry.
4. Sear in a very hot heavy pan on all sides. Optional: flambé with Cognac.
5. Deglaze pan with reserved liquid and beef stock for a natural sauce.
6. Insert MEATER probe. **Core should read 58–62 °C (136–144 °F)**.
7. Slice into strips; serve with seasonal vegetables and sauce.
