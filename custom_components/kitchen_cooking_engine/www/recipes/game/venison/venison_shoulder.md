...
- [Oven Roast](./venison_shoulder-oven_roast.md) — stub; oven roast recipes not yet sourced
- [Slow Cooker](./venison_shoulder-slow_cooker.md) — stub; slow cooker recipes not yet sourced
...
| Braise leaf incomplete (2 of 4–6 sources) | −1 |
| Oven roast leaf not yet populated | −3 |
| Slow cooker leaf not yet populated | −2 |
| No per-method temperature consensus (analysis gate not met) | −2 |

### Improvement priorities

1. **−3** · Oven roast leaf empty — find venison shoulder oven roast recipes with full ingredient quantities
2. **−2** · Slow cooker leaf empty — find venison shoulder slow cooker recipes
3. **−2** · No temperature consensus — add more sources; once 4+ per method, write analysis sections
4. **−1** · Braise leaf incomplete — add 2–4 more braise sources from Groups A and C
