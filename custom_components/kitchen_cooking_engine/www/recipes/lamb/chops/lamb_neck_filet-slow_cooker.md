...
> ⚠️ **COLLECTION NOT YET STARTED** — No complete source recipes with full ingredient quantities have been verified for the slow cooker method.  
>  
> **Priority**: Find slow cooker lamb neck fillet recipes with full ingredient quantities. British food blogs, Australian slow cooker sites, and Nordic cooking sites (ICA.se, koket.se) are likely sources.
