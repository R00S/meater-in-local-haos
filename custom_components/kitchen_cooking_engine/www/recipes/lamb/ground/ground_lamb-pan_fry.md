...
| Cut slug | `ground_lamb` |
| Method slug | `pan_fry` |
| File | `ground_lamb-pan_fry.md` |
| Full path | `docs/recipe_research/lamb/ground/ground_lamb-pan_fry.md` |
...
- 2 tomatoes, diced (or 200 g canned)
- 1 tsp red pepper paste (biber salçası)
- 1 tsp salt, ½ tsp pepper
- 3 tbsp sunflower oil

**Method**
1. Heat oil in a wide pan. Sauté onion until golden. Add garlic and cook 1 minute.
2. Add ground lamb, breaking up with a wooden spoon. Cook over high heat until browned and all liquid has evaporated.
3. Add tomatoes, pepper paste, salt, and pepper. Stir.
4. Add diced potatoes. Add 200 ml water, cover and simmer 20 minutes until potatoes are tender.
5. Insert probe into the meat (thickest collected mass). **Verify 74 °C (165 °F)**.
6. Serve with Turkish bread and yoghurt.
...
**Ingredients**
- 500 g ground lamb (or beef/goat)
- 2 medium onions, finely chopped
- 2 tomatoes, finely chopped (or 200 g canned)
...
**Method**
1. Heat oil. Sauté onions until golden. Add ginger-garlic paste, cook 2 minutes.
2. Add tomatoes and cook until mushy and oil separates (about 8 minutes).
3. Add all ground spices; stir 1 minute.
4. Add ground lamb. Break up lumps and cook on high heat 5 minutes until no longer pink.
5. Add peas and a splash of water. Cover and cook on medium-low 12–15 minutes.
6. Insert probe into the thickest collected mass of meat. **Verify 74 °C (165 °F)**.
7. Garnish with coriander. Serve with naan, paratha, or rice.
*Final temperature: 74–76 °C (165–169 °F).*
...
**Method** *(pan-fry phase):*
1. Heat oil in a wide pan over high heat. Cook onion 5 minutes. Add garlic, cook 1 minute.
2. Add lamb mince, breaking up with a spoon. Sear over high heat until thoroughly browned.
3. Add tomato purée, wine, tomatoes, oregano, and cinnamon. Season.
4. Simmer 20 minutes until sauce is thick and rich.
5. **Ground lamb is safe at 74 °C (165 °F)** which is reached well within this cooking time.
6. Use in moussaka or serve as a sauce over pasta (pastitsio style).
*Final temperature: well above 74 °C (165 °F) by the time the dish is assembled.*
...
|----------|---------------|-------|
| Ground meat safety | 74 °C (165 °F) | EU and US standard |
