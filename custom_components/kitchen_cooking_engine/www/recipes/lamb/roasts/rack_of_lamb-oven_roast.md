...
| Cut slug | `rack_of_lamb` |
| Method slug | `oven_roast` |
| File | `rack_of_lamb-oven_roast.md` |
| Full path | `docs/recipe_research/lamb/roasts/rack_of_lamb-oven_roast.md` |
...
### 1. Herb-Crusted Rack of Lamb (inspired by BBC Good Food)
...
**Ingredients**
- 2 racks of lamb (7–8 ribs each, Frenched)
- Salt and black pepper
- 2 tbsp olive oil

*Herb crust (persillade):*
...
**Method**
1. Preheat oven to 200 °C. Season racks with salt and pepper.
2. Heat oil in an ovenproof frying pan over high heat. Sear racks all over (3–4 minutes) until golden.
3. Mix breadcrumbs, herbs, and garlic. Brush seared racks with Dijon mustard. Press herb crust firmly onto the fat-cap side.
4. Place racks crust-side up in the pan. Insert MEATER probe into the thickest part of the loin (not touching bone).
5. Roast 20–25 minutes until probe reads **52 °C (126 °F)** for medium-rare.
6. Rest 10 minutes (temperature will rise to 55–57 °C). Slice into individual cutlets.
7. Serve with dauphinoise potatoes and a dressed watercress salad.
*Final resting temperature: 55–57 °C (131–135 °F).*

---

### 2. Classic Rack of Lamb with Red Wine Sauce (inspired by Great British Chefs)
...
**Ingredients**
- 1 rack of lamb (7 ribs, Frenched)
- Salt and pepper
...
**Method**
1. Season rack. Sear in hot oil 3 minutes per side in an oven-safe pan. Add garlic and rosemary.
2. Transfer to 200 °C oven. Insert probe. Roast 15–18 minutes until **52–54 °C (126–129 °F)**.
3. Rest 8 minutes.
4. **Sauce**: Deglaze pan with wine; reduce by half. Add stock and jelly; reduce further. Whisk in butter.
5. Slice into cutlets. Serve with sauce and spring vegetables.
*Final resting temperature: 55–57 °C (131–135 °F).*

---

### 3. Rack of Lamb with Herb Crust (inspired by RecipeTinEats.com)
...
**Ingredients**
- 2 racks of lamb (7–8 ribs each, Frenched and trimmed)
- Salt and pepper
...
**Method**
1. Season racks with salt and pepper 30 minutes before cooking.
2. Preheat oven to 200 °C. Sear racks meaty side down in a hot pan 3 minutes. Let cool 2 minutes.
3. Mix panko, herbs, garlic, and 2 tbsp oil. Brush racks with mustard; press crust on fat side.
4. Insert probe. Roast crust-side up 20–25 minutes until probe reads **52–54 °C (126–129 °F)**.
...
| Doneness | Pull temp | Final (after 10 min rest) |
|----------|-----------|--------------------------|
...
### 4. Mediterranean Garlic and Herb Rack of Lamb (inspired by The Mediterranean Dish)
