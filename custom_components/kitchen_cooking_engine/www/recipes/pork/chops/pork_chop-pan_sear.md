...
### 1. Chuleta de cerdo a la plancha (inspired by Directo al Paladar)
...
**Ingredients**
- 1–2 pork chops (aguja/neck preferred), approx. 2 cm thick
- A few drops of olive oil (rubbed on chop only)
- Flaked salt (applied after cooking)
- Freshly ground black pepper

**Method**
1. Remove chops from fridge **15 minutes** before cooking to temper.
2. Rub each chop with a few drops of olive oil on both sides.
3. Heat pan on medium-high. Let it get properly hot.
4. Place chop. Cook **1 minute 30 seconds** without touching.
5. Flip. Cook second side **1 minute 30 seconds** without moving.
6. Remove. Season with flaked salt and pepper off the heat.
7. Rest **1 minute** before slicing.
8. Insert MEATER probe. **Core: 63–65 °C (145–149 °F)**.
*Final temperature: 63–65 °C (145–149 °F).*

---

### 2. Schweinskotelett Grundrezept (inspired by ichkoche.at)
...
**Method**
1. Heat pan **without fat** until very hot.
2. Add oil. Place chops immediately.
3. Fry **2 minutes undisturbed** on first side for full Maillard crust.
4. Turn. Add garlic, herbs, and butter.
5. Fry second side **2 minutes** basting with herb butter continuously.
6. Remove. Season with salt and pepper. Serve immediately.
7. Insert MEATER probe before serving. **Core: 63–65 °C (145–149 °F)**.
*Final temperature: 63–65 °C (145–149 °F).*

---

### 3. Pandestegning af koteletter (inspired by Madens Verden)
...
**Ingredients**
- 2 pork chops, 175 g each
- Generous butter knob
- 2 garlic cloves, 2 rosemary sprigs, 2 thyme sprigs
- Salt (20 min ahead), freshly ground pepper

**Method**
1. Salt both sides **20 min** before cooking.
2. Heat pan to high. Add butter; let it foam.
3. Place chops. Press lightly. Sear **2 minutes** undisturbed.
4. Turn; sear second side **2 minutes**.
5. Reduce heat slightly. Add garlic and herbs. Baste constantly with butter **2 more min per side**.
...
### 4. Smothered Pork Chops (inspired by African Bites / Immaculate Bites)
