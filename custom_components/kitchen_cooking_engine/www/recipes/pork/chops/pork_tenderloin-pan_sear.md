...
**Ingredients**
- 1 pork tenderloin, approx. 300–400 g, silverskin removed
- A little olive oil
- Salt and pepper

**Method**
1. Remove silverskin from tenderloin. Slice into medallions (4–5 cm rounds). Season with salt and pepper.
2. Heat a griddle pan (sartén tipo grill) with a thread of olive oil over high heat.
3. When hot, add medallions. Cook **2 minutes per side** without moving.
4. Remove. Serve immediately with broccoli and mashed potatoes.
...
**Temperature guidance (from recipe)**: Oven at 200 °C for 15 minutes after browning. "Cool butter stirred into the sauce in small pieces."

**Ingredients**
- 1 pork tenderloin (whole), silverskin removed
- Butter (for browning)
- 4 rashers bacon (overlapping sheet)
- 1 tbsp Dijon mustard
- Handful fresh herbs (parsley, thyme), chopped
- 3 tbsp breadcrumbs
...
**Method**
1. Season tenderloin with salt and pepper. Melt butter in an ovenproof pan; brown tenderloin on all sides.
2. Remove from pan. Chop fresh herbs; mix with breadcrumbs and salt.
3. Lay 4 bacon slices overlapping on plastic wrap. Brush with mustard; sprinkle herb-crumb mix. Place tenderloin on top; roll into a bacon parcel using the film. Tie with kitchen string.
4. Return to pan; brown bacon wrap on all sides briefly. Add shallots; cook 1 minute.
5. Add beef stock; bring to boil.
6. Transfer to oven at **200 °C × 15 minutes**.
7. Remove. Insert MEATER probe. **Core: 63–65 °C (145–149 °F)**.
8. Remove string. Stir cold butter in small pieces into the pan juices for the sauce.
...
**Ingredients**
- 1 pork tenderloin (afpudset — silverskin removed)
- Oil or butter
- Salt and freshly ground pepper

**Method**
1. Remove silverskin carefully with a sharp knife.
2. Heat pan to high; add oil.
3. Sear tenderloin **1 minute per side** on all 4 sides (approx. 4 min to brown all around).
4. Reduce heat to medium. Continue cooking **2 minutes per quarter-turn** — 4 turns × 2 min = 8 more minutes.
