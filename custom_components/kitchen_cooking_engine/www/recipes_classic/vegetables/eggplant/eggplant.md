...
- [Air Fryer](./eggplant-air_fryer.md)
- [Grill](./eggplant-grill.md)
...
3. **−1** · Method file `eggplant-grill.md` copies parent cut profile — rewrite `eggplant-grill.md`'s cut profile section with method-specific analysis — what this method does to this cut, carryover behaviour, why it suits it
