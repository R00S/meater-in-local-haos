# T Bone × Charcoal Grill — Recipe Temperature Research
...
| Cut slug | `t_bone` |
| Method slug | `charcoal_grill` |
| File | `t_bone-charcoal_grill.md` |
| Full path | `docs/recipe_research/beef/steaks/t_bone-charcoal_grill.md` |
