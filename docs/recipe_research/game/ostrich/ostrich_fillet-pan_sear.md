# Ostrich Fillet × Pan Sear — Recipe Temperature Research
...
>  
> Research note: The following sources were found but could not be verified with full ingredient lists accessible via web_fetch:  
> - The Roasted Dad (Shawn Godfrey, MasterChef South Africa winner) — https://theroasteddad.com/recipes/ostrich-steak-recipe — mentions olive oil, rosemary, thyme, butter, but the structured recipe card (ingredients with quantities) is not accessible via web_fetch (JavaScript-rendered).  
> - taste.co.za — https://www.taste.co.za/recipes/ostrich-fillet/ — confirmed URL, Wellington-style preparation, method accessible but ingredient quantities not confirmed.  
>  
> **Priority**: Find a properly sourced ostrich fillet pan sear recipe with a verified URL and full ingredient quantities accessible via web_fetch. South African food media (taste.co.za named recipes, Woolworths Food) and European food media (chefkoch.de with different Strauß recipe, Jamie Oliver UK if applicable) are likely starting points.
