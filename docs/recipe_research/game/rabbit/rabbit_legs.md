...
2. **−1** · Method file `rabbit_legs-braise.md` copies parent cut profile — rewrite `rabbit_legs-braise.md`'s cut profile section with method-specific analysis — what this method does to this cut, carryover behaviour, why it suits it
