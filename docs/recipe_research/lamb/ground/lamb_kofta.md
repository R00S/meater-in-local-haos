...
1. **−1** · Missing method leaf file — create `lamb_kofta-oven_roast.md` with 4–6 diverse source recipes, a method-specific cut profile, and pull temperatures from sources
...
4. **−1** · Method file `lamb_kofta-grill.md` copies parent cut profile — rewrite `lamb_kofta-grill.md`'s cut profile section with method-specific analysis — what this method does to this cut, carryover behaviour, why it suits it
