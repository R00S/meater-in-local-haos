...
1. **−2** · Missing method leaf files — create the following 2 missing files, each with 4–6 diverse source recipes, a method-specific cut profile, and pull temperatures from sources: `pork_loin_steak-air_fryer.md`, `pork_loin_steak-grill.md`
...
3. **−1** · Method file `pork_loin_steak-pan_fry.md` copies parent cut profile — rewrite `pork_loin_steak-pan_fry.md`'s cut profile section with method-specific analysis — what this method does to this cut, carryover behaviour, why it suits it
