...
1. **−1** · Method file `pork_shoulder-oven_roast.md` copies parent cut profile — rewrite `pork_shoulder-oven_roast.md`'s cut profile section with method-specific analysis — what this method does to this cut, carryover behaviour, why it suits it
