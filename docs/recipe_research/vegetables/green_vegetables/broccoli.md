...
2. **−1** · Method file `broccoli-saute.md` copies parent cut profile — rewrite `broccoli-saute.md`'s cut profile section with method-specific analysis — what this method does to this cut, carryover behaviour, why it suits it
