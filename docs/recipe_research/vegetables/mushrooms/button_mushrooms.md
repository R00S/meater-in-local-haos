...
2. **−1** · Method file `button_mushrooms-grill.md` copies parent cut profile — rewrite `button_mushrooms-grill.md`'s cut profile section with method-specific analysis — what this method does to this cut, carryover behaviour, why it suits it
