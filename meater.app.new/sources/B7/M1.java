...
public final class M1 {
    ...
    private static M1 f1753b;

    /* renamed from: c, reason: collision with root package name */
    static final byte[] f1754c;

    /* renamed from: d, reason: collision with root package name */
    static final byte[] f1755d;
    ...
    static final boolean c(PackageInfo packageInfo, boolean z10) {
        if (packageInfo.signatures.length == 1) {
            return z10 ? d(packageInfo, f1754c, f1755d) : d(packageInfo, f1754c);
        }
        Log.w("WearSignatureVerifier", "Package has more than one signature.");
        return false;
    }

    private static final boolean d(PackageInfo packageInfo, byte[]... bArr) {
    ...
    public final boolean b() {
        ...
        boolean zC;
        try {
            packageInfoE = l7.c.a(this.f1756a).e("com.google.android.wearable.app.cn", 64);
        } catch (PackageManager.NameNotFoundException unused) {
            packageInfoE = null;
        }
        if (packageInfoE != null) {
            if (C2339h.d(this.f1756a)) {
                zC = c(packageInfoE, true);
            } else {
                boolean zC2 = c(packageInfoE, false);
                if (zC2 || !c(packageInfoE, true)) {
                    zC = zC2;
                } else {
