...
public final class C0985c extends AbstractC2913x<C0985c, b> implements Q {
    private static final C0985c DEFAULT_INSTANCE;
    private static volatile Y<C0985c> PARSER = null;
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f3531a[AbstractC2913x.f.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f3531a[AbstractC2913x.f.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f3531a[AbstractC2913x.f.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f3531a[AbstractC2913x.f.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f3531a[AbstractC2913x.f.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f3531a[AbstractC2913x.f.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* compiled from: AesCmacParams.java */
    /* renamed from: D8.c$b */
    public static final class b extends AbstractC2913x.a<C0985c, b> implements Q {
        /* synthetic */ b(a aVar) {
            this();
        }
        ...
        private b() {
            super(C0985c.DEFAULT_INSTANCE);
        }
    }

    static {
        C0985c c0985c = new C0985c();
        DEFAULT_INSTANCE = c0985c;
        AbstractC2913x.U(C0985c.class, c0985c);
    }

    private C0985c() {
    }

    public static C0985c Z() {
    ...
    protected final Object z(AbstractC2913x.f fVar, Object obj, Object obj2) {
        a aVar = null;
        switch (a.f3531a[fVar.ordinal()]) {
            case 1:
                return new C0985c();
            case 2:
                return new b(aVar);
            case 3:
                return AbstractC2913x.M(DEFAULT_INSTANCE, "\u0000\u0001\u0000\u0000\u0001\u0001\u0001\u0000\u0000\u0000\u0001\u000b", new Object[]{"tagSize_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                Y<C0985c> bVar = PARSER;
                if (bVar == null) {
                    synchronized (C0985c.class) {
                        try {
                            bVar = PARSER;
                            if (bVar == null) {
