...
public final class C0988f extends AbstractC2913x<C0988f, b> implements Q {
    private static final C0988f DEFAULT_INSTANCE;
    public static final int KEY_VALUE_FIELD_NUMBER = 3;
    public static final int PARAMS_FIELD_NUMBER = 2;
    private static volatile Y<C0988f> PARSER = null;
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f3534a[AbstractC2913x.f.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f3534a[AbstractC2913x.f.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f3534a[AbstractC2913x.f.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f3534a[AbstractC2913x.f.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f3534a[AbstractC2913x.f.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f3534a[AbstractC2913x.f.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* compiled from: AesCtrKey.java */
    /* renamed from: D8.f$b */
    public static final class b extends AbstractC2913x.a<C0988f, b> implements Q {
        /* synthetic */ b(a aVar) {
            this();
        }
        ...
        public b D(AbstractC2898h abstractC2898h) {
            s();
            ((C0988f) this.f38040C).i0(abstractC2898h);
            return this;
        }

        public b E(C0990h c0990h) {
            s();
            ((C0988f) this.f38040C).j0(c0990h);
            return this;
        }

        public b F(int i10) {
            s();
            ((C0988f) this.f38040C).k0(i10);
            return this;
        }
        ...
        private b() {
            super(C0988f.DEFAULT_INSTANCE);
        }
    }

    static {
        C0988f c0988f = new C0988f();
        DEFAULT_INSTANCE = c0988f;
        AbstractC2913x.U(C0988f.class, c0988f);
    }

    private C0988f() {
    }

    public static C0988f b0() {
    ...
    public static C0988f h0(AbstractC2898h abstractC2898h, C2905o c2905o) {
        return (C0988f) AbstractC2913x.O(DEFAULT_INSTANCE, abstractC2898h, c2905o);
    }
    ...
    protected final Object z(AbstractC2913x.f fVar, Object obj, Object obj2) {
        ...
        switch (a.f3534a[fVar.ordinal()]) {
            ...
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                Y<C0988f> bVar = PARSER;
                if (bVar == null) {
                    synchronized (C0988f.class) {
                        try {
                            bVar = PARSER;
                            if (bVar == null) {
