...
public final class p extends AbstractC2913x<p, b> implements Q {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f3544a[AbstractC2913x.f.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f3544a[AbstractC2913x.f.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f3544a[AbstractC2913x.f.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f3544a[AbstractC2913x.f.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f3544a[AbstractC2913x.f.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f3544a[AbstractC2913x.f.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* compiled from: AesSivKey.java */
    public static final class b extends AbstractC2913x.a<p, b> implements Q {
        /* synthetic */ b(a aVar) {
            this();
        }
        ...
        public b D(AbstractC2898h abstractC2898h) {
            s();
            ((p) this.f38040C).e0(abstractC2898h);
            return this;
        }

        public b E(int i10) {
            s();
            ((p) this.f38040C).g0(i10);
            return this;
        }
    ...
    public static p d0(AbstractC2898h abstractC2898h, C2905o c2905o) {
        return (p) AbstractC2913x.O(DEFAULT_INSTANCE, abstractC2898h, c2905o);
    }
