...
public final class t extends AbstractC2913x<t, b> implements Q {
    private static final t DEFAULT_INSTANCE;
    public static final int ENCRYPTED_KEYSET_FIELD_NUMBER = 2;
    public static final int KEYSET_INFO_FIELD_NUMBER = 3;
    private static volatile Y<t> PARSER;
    private AbstractC2898h encryptedKeyset_ = AbstractC2898h.f37801C;
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f3548a[AbstractC2913x.f.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f3548a[AbstractC2913x.f.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f3548a[AbstractC2913x.f.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f3548a[AbstractC2913x.f.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f3548a[AbstractC2913x.f.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f3548a[AbstractC2913x.f.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* compiled from: EncryptedKeyset.java */
    public static final class b extends AbstractC2913x.a<t, b> implements Q {
        /* synthetic */ b(a aVar) {
            this();
        }
        ...
        public b D(AbstractC2898h abstractC2898h) {
            s();
            ((t) this.f38040C).d0(abstractC2898h);
            return this;
        }

        public b E(D d10) {
            s();
            ((t) this.f38040C).e0(d10);
            return this;
        }
    ...
    public static t c0(InputStream inputStream, C2905o c2905o) {
        return (t) AbstractC2913x.P(DEFAULT_INSTANCE, inputStream, c2905o);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void d0(AbstractC2898h abstractC2898h) {
        abstractC2898h.getClass();
        this.encryptedKeyset_ = abstractC2898h;
    }
