...
class t {
    ...
    private final Deque<WeakReference<XmlPullParser>> f20777a = new ArrayDeque();
    ...
    boolean a(AttributeSet attributeSet) {
        ...
        XmlPullParser xmlPullParserC = c(this.f20777a);
        this.f20777a.push(new WeakReference<>(xmlPullParser));
