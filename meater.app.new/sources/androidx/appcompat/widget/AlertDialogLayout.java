...
public class AlertDialogLayout extends C0157c0 {
    public AlertDialogLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    /* renamed from: A */
    private void m745A(View view, int i2, int i3, int i4, int i5) {
        view.layout(i2, i3, i4 + i2, i5 + i3);
    }

    /* renamed from: B */
    private static int m746B(View view) throws NoSuchFieldException {
        int iM2164z = C0311u.m2164z(view);
        if (iM2164z > 0) {
            return iM2164z;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m746B(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    /* renamed from: C */
    private boolean m747C(int i2, int i3) throws NoSuchFieldException {
        ...
        for (int i4 = 0; i4 < childCount; i4++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C0828f.f5135P) {
                    view = childAt;
                } else if (id == C0828f.f5146k) {
                    view2 = childAt;
                } else {
                    if ((id != C0828f.f5148m && id != C0828f.f5150o) || view3 != null) {
                        return false;
                    }
                    view3 = childAt;
                }
        ...
        if (view2 != null) {
            view2.measure(i2, 0);
            iM746B = m746B(view2);
            measuredHeight = view2.getMeasuredHeight() - iM746B;
            paddingTop += iM746B;
        ...
        if (view2 != null) {
            int i6 = paddingTop - iM746B;
            int iMin = Math.min(i5, measuredHeight);
            if (iMin > 0) {
                i5 -= iMin;
                iM746B += iMin;
            }
            view2.measure(i2, View.MeasureSpec.makeMeasureSpec(iM746B, 1073741824));
    ...
    /* renamed from: l */
    private void m748l(int i2, int i3) {
        int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824);
        for (int i4 = 0; i4 < i2; i4++) {
            View childAt = getChildAt(i4);
            if (childAt.getVisibility() != 8) {
                C0157c0.a aVar = (C0157c0.a) childAt.getLayoutParams();
    ...
    */
    protected void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L5a:
            ...
            r15 = r2
            androidx.appcompat.widget.c0$a r15 = (androidx.appcompat.widget.C0157c0.a) r15
            int r2 = r15.f1063b
            if (r2 >= 0) goto L7e
            r2 = r11
        L7e:
            int r3 = androidx.core.view.C0311u.m2162y(r17)
            int r2 = androidx.core.view.C0286d.m1932b(r2, r3)
            r2 = r2 & 7
            r3 = 1
            if (r2 == r3) goto L97
            r3 = 5
