    ...
    private boolean C(int i10, int i11) {
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id2 == i.f.f42499O) {
                    view = childAt;
                } else if (id2 == i.f.f42510k) {
                    view2 = childAt;
                } else {
                    if ((id2 != i.f.f42512m && id2 != i.f.f42514o) || view3 != null) {
                        return false;
                    }
                    view3 = childAt;
                }
        ...
        if (view2 != null) {
            int i14 = paddingTop - iB;
            int iMin = Math.min(i13, measuredHeight);
            if (iMin > 0) {
                i13 -= iMin;
                iB += iMin;
            }
            view2.measure(i10, View.MeasureSpec.makeMeasureSpec(iB, 1073741824));
