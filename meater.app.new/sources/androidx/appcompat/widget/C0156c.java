...
public class C0156c extends AutoCompleteTextView implements InterfaceC0310t {

    /* renamed from: f */
    private static final int[] f1044f = {R.attr.popupBackground};

    /* renamed from: g */
    private final C0158d f1045g;

    /* renamed from: h */
    private final C0188s f1046h;
    ...
    protected void drawableStateChanged() {
        ...
        C0158d c0158d = this.f1045g;
        if (c0158d != null) {
            c0158d.m918b();
        }
        C0188s c0188s = this.f1046h;
        if (c0188s != null) {
            c0188s.m1155b();
        }
    }
    ...
    public C0156c(Context context, AttributeSet attributeSet, int i2) throws Resources.NotFoundException, IllegalArgumentException {
        super(C0179n0.m1077b(context), attributeSet, i2);
        C0175l0.m1068a(this, getContext());
        C0185q0 c0185q0M1091v = C0185q0.m1091v(getContext(), attributeSet, f1044f, i2, 0);
