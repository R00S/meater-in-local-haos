...
public class e {
    ...
    public Bundle a() {
        return a.a((ViewStructure) this.f23055a);
    }

    public void b(String str) {
        a.b((ViewStructure) this.f23055a, str);
    }

    public void c(CharSequence charSequence) {
        a.c((ViewStructure) this.f23055a, charSequence);
    }

    public void d(int i10, int i11, int i12, int i13, int i14, int i15) {
        a.d((ViewStructure) this.f23055a, i10, i11, i12, i13, i14, i15);
    }

    public void e(int i10, String str, String str2, String str3) {
        a.e((ViewStructure) this.f23055a, i10, str, str2, str3);
    }

    public void f(CharSequence charSequence) {
        a.f((ViewStructure) this.f23055a, charSequence);
    }

    public void g(float f10, int i10, int i11, int i12) {
        a.g((ViewStructure) this.f23055a, f10, i10, i11, i12);
    }

    public ViewStructure h() {
        return (ViewStructure) this.f23055a;
    }
}
