...
final class q0 {
    ...
    private static final b f25044a;
    ...
    static final class e extends b {
        ...
        */
        ...
        private static int h(byte[] bArr, int i10, long j10, int i11) {
            ...
            if (i11 == 1) {
                return q0.j(i10, p0.s(bArr, j10));
            }
            if (i11 == 2) {
                return q0.k(i10, p0.s(bArr, j10), p0.s(bArr, j10 + 1));
            }
        ...
        String a(byte[] bArr, int i10, int i11) throws InvalidProtocolBufferException {
            ...
            while (i10 < i12) {
                int i15 = i10 + 1;
                byte bS2 = p0.s(bArr, i10);
                if (a.n(bS2)) {
                    int i16 = i14 + 1;
                    a.i(bS2, cArr, i14);
                    while (i15 < i12) {
                        byte bS3 = p0.s(bArr, i15);
                        if (!a.n(bS3)) {
                            break;
                        }
                        i15++;
                    ...
                    i10 += 2;
                    a.k(bS2, p0.s(bArr, i15), cArr, i14);
                    i14++;
                } else if (a.o(bS2)) {
                    if (i15 >= i12 - 1) {
                        throw InvalidProtocolBufferException.c();
                    ...
                    int i17 = i10 + 2;
                    i10 += 3;
                    a.j(bS2, p0.s(bArr, i15), p0.s(bArr, i17), cArr, i14);
                    i14++;
                } else {
                    if (i15 >= i12 - 2) {
                        throw InvalidProtocolBufferException.c();
                    }
                    byte bS4 = p0.s(bArr, i15);
                    int i18 = i10 + 3;
                    byte bS5 = p0.s(bArr, i10 + 2);
                    i10 += 4;
                    a.h(bS2, bS4, bS5, p0.s(bArr, i18), cArr, i14);
                    i14 += 2;
                }
            }
            return new String(cArr, 0, i14);
            ...
            while (i13 < length) {
                ...
                if (cCharAt2 >= 128 || j13 >= j14) {
                    if (cCharAt2 >= 2048 || j13 > j14 - 2) {
                        ...
                        p0.H(bArr, j13, (byte) ((cCharAt2 >>> '\f') | 480));
                        long j16 = j13 + 2;
                        p0.H(bArr, j13 + 1, (byte) (((cCharAt2 >>> 6) & 63) | 128));
                        j13 += 3;
                        ...
                        str2 = str4;
                        long j17 = j13 + j10;
                        p0.H(bArr, j13, (byte) ((cCharAt2 >>> 6) | 960));
                        j13 += 2;
                        p0.H(bArr, j17, (byte) ((cCharAt2 & '?') | 128));
                    }
                    j12 = j14;
                    j11 = 1;
                } else {
                    p0.H(bArr, j13, (byte) cCharAt2);
                    j12 = j14;
                    str2 = str4;
                    j11 = j10;
                    j13 += j10;
        ...
        /* JADX WARN: Code restructure failed: missing block: B:35:0x0058, code lost:
            ...
            if (androidx.datastore.preferences.protobuf.p0.s(r12, r0) > (-65)) goto L38;
         */
        /* JADX WARN: Code restructure failed: missing block: B:58:0x009e, code lost:
        
            if (androidx.datastore.preferences.protobuf.p0.s(r12, r0) > (-65)) goto L59;
         */
        @Override // androidx.datastore.preferences.protobuf.q0.b
        /*
            Code decompiled incorrectly, please refer to instructions dump.
    ...
    public static boolean m(byte[] bArr) {
        return f25044a.c(bArr, 0, bArr.length);
    }

    public static boolean n(byte[] bArr, int i10, int i11) {
        return f25044a.c(bArr, i10, i11);
    }
}
