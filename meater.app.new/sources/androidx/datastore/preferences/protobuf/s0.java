...
interface s0 {
    ...
    void I(int i10, List<AbstractC2062h> list);
    ...
    void L(int i10, AbstractC2062h abstractC2062h);

    void M(int i10, Object obj, f0 f0Var);

    <K, V> void N(int i10, I.a<K, V> aVar, Map<K, V> map);

    @Deprecated
    void O(int i10, Object obj, f0 f0Var);
