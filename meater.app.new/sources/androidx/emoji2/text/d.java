...
public final class d {
    ...
    public static class a {
        ...
        public a(b bVar) {
            this.f25196a = bVar == null ? e() : bVar;
        }

        private f.c a(Context context, o1.e eVar) {
            if (eVar == null) {
                return null;
            }
        ...
        private o1.e d(ProviderInfo providerInfo, PackageManager packageManager) {
            String str = providerInfo.authority;
            String str2 = providerInfo.packageName;
            return new o1.e(str, str2, "emojicompat-emoji-font", b(this.f25196a.b(packageManager, str2)));
        }

        private static b e() {
            return Build.VERSION.SDK_INT >= 28 ? new C0353d() : new c();
        }
        ...
        private ProviderInfo g(PackageManager packageManager) {
            Iterator<ResolveInfo> it = this.f25196a.c(packageManager, new Intent("androidx.content.action.LOAD_EMOJI_FONT"), 0).iterator();
            while (it.hasNext()) {
                ProviderInfo providerInfoA = this.f25196a.a(it.next());
                if (f(providerInfoA)) {
        ...
        o1.e h(Context context) {
            PackageManager packageManager = context.getPackageManager();
            r1.i.h(packageManager, "Package manager required to locate emoji font provider");
    ...
    public static class C0353d extends c {
        @Override // androidx.emoji2.text.d.b
        public Signature[] b(PackageManager packageManager, String str) {
            return packageManager.getPackageInfo(str, 64).signatures;
        }
