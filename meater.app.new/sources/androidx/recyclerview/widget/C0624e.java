...
public class C0624e extends AbstractC0636q {
    ...
    private void animateRemoveImpl(RecyclerView.AbstractC0590c0 abstractC0590c0) {
        ...
        viewPropertyAnimatorAnimate.setDuration(getRemoveDuration()).alpha(0.0f).setListener(new d(abstractC0590c0, viewPropertyAnimatorAnimate, view)).start();
    }
    ...
    void animateAddImpl(RecyclerView.AbstractC0590c0 abstractC0590c0) {
        ...
        viewPropertyAnimatorAnimate.alpha(1.0f).setDuration(getAddDuration()).setListener(new e(abstractC0590c0, view, viewPropertyAnimatorAnimate)).start();
    }
    ...
    void animateMoveImpl(RecyclerView.AbstractC0590c0 abstractC0590c0, int i2, int i3, int i4, int i5) {
        ...
        viewPropertyAnimatorAnimate.setDuration(getMoveDuration()).setListener(new f(abstractC0590c0, i6, view, i7, viewPropertyAnimatorAnimate)).start();
    }
