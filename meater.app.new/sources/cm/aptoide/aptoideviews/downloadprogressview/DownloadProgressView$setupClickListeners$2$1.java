...
final class DownloadProgressView$setupClickListeners$2$1 extends Lambda implements Function0<C10775u> {
    ...
    public final void invoke2() {
        if (this.this$0.isPausable) {
            if (C9801m.m32341a(this.this$0.stateMachine.m29075b(), State.InProgress.INSTANCE)) {
                this.this$0.stateMachine.m29076g(Event.PauseClick.INSTANCE);
            } else {
                this.this$0.stateMachine.m29076g(Event.ResumeClick.INSTANCE);
            }
        }
    }
}
