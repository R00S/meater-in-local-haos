...
public final class ApplicationModule_ProvidesABRetrofitFactory implements Provider {
    ...
    public static Retrofit providesABRetrofit(ApplicationModule applicationModule, String str, OkHttpClient okHttpClient, Converter.Factory factory, CallAdapter.Factory factory2) {
        return (Retrofit) C9055b.m29112c(applicationModule.providesABRetrofit(str, okHttpClient, factory, factory2));
    }
