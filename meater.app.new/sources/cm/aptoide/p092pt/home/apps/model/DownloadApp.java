...
public final /* data */ class DownloadApp implements StateApp {
    ...
    public DownloadApp(String str, String str2, String str3, String str4, int i2, String str5, int i3, StateApp.Status status, long j2) {
        ...
        C9801m.m32346f(str2, "md5");
        C9801m.m32346f(str3, RoomInstalled.ICON);
        C9801m.m32346f(str4, "packageName");
        C9801m.m32346f(str5, "version");
        this.name = str;
        this.md5 = str2;
        this.icon = str3;
    ...
    public final DownloadApp copy(String name, String md5, String icon, String packageName, int progress, String version, int versionCode, StateApp.Status status, long appId) {
        ...
        C9801m.m32346f(version, "version");
    ...
    public boolean equals(Object other) {
        ...
        return C9801m.m32341a(this.name, downloadApp.name) && C9801m.m32341a(getMd5(), downloadApp.getMd5()) && C9801m.m32341a(this.icon, downloadApp.icon) && C9801m.m32341a(getPackageName(), downloadApp.getPackageName()) && getProgress() == downloadApp.getProgress() && C9801m.m32341a(this.version, downloadApp.version) && getVersionCode() == downloadApp.getVersionCode() && getStatus() == downloadApp.getStatus() && this.appId == downloadApp.appId;
    }
    ...
    public int hashCode() {
        return (((((((((((((((this.name.hashCode() * 31) + getMd5().hashCode()) * 31) + this.icon.hashCode()) * 31) + getPackageName().hashCode()) * 31) + getProgress()) * 31) + this.version.hashCode()) * 31) + getVersionCode()) * 31) + (getStatus() == null ? 0 : getStatus().hashCode())) * 31) + C1152a.m6829a(this.appId);
    }
    ...
    public /* synthetic */ DownloadApp(String str, String str2, String str3, String str4, int i2, String str5, int i3, StateApp.Status status, long j2, int i4, C9789g c9789g) {
