...
public class EditorsBundleViewHolder extends AppBundleViewHolder {
    ...
    public EditorsBundleViewHolder(View view, C11418b<HomeEvent> c11418b, DecimalFormat decimalFormat, String str) {
        super(view);
        this.marketName = str;
        ...
        RecyclerView recyclerView = (RecyclerView) view.findViewById(C1146R.id.featured_graphic_list);
        this.graphicsList = recyclerView;
        EditorsAppsAdapter editorsAppsAdapter = new EditorsAppsAdapter(new ArrayList(), decimalFormat, c11418b);
        this.graphicAppsAdapter = editorsAppsAdapter;
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(view.getContext(), 0, false);
        recyclerView.addItemDecoration(new RecyclerView.AbstractC0601n() { // from class: cm.aptoide.pt.home.bundles.editorschoice.EditorsBundleViewHolder.1
        ...
        this.skeleton = SkeletonUtils.applySkeleton(recyclerView, C1146R.layout.feature_graphic_home_item_skeleton, Type.APPS_GROUP.getPerLineCount(view.getContext().getResources(), (WindowManager) view.getContext().getSystemService("window")) * 3);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$setBundle$0, reason: merged with bridge method [inline-methods] */
    public /* synthetic */ void m8084a(HomeBundle homeBundle, View view) {
    ...
    public void setBundle(final HomeBundle homeBundle, int i2) {
        ...
        this.graphicsList.addOnScrollListener(new RecyclerView.AbstractC0607t() { // from class: cm.aptoide.pt.home.bundles.editorschoice.EditorsBundleViewHolder.2
        ...
        this.moreButton.setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.home.bundles.editorschoice.a
            ...
            public final void onClick(View view) {
                this.f9578f.m8084a(homeBundle, view);
            }
        });
    }
}
