...
public class C2424c implements InterfaceC3975j<Bitmap> {

    /* renamed from: b, reason: collision with root package name */
    public static final C3971f<Integer> f33318b = C3971f.f("com.bumptech.glide.load.resource.bitmap.BitmapEncoder.CompressionQuality", 90);

    /* renamed from: c, reason: collision with root package name */
    public static final C3971f<Bitmap.CompressFormat> f33319c = C3971f.e("com.bumptech.glide.load.resource.bitmap.BitmapEncoder.CompressionFormat");

    /* renamed from: a, reason: collision with root package name */
    private final InterfaceC4237b f33320a;

    public C2424c(InterfaceC4237b interfaceC4237b) {
        this.f33320a = interfaceC4237b;
    }

    private Bitmap.CompressFormat d(Bitmap bitmap, C3972g c3972g) {
        Bitmap.CompressFormat compressFormat = (Bitmap.CompressFormat) c3972g.c(f33319c);
        return compressFormat != null ? compressFormat : bitmap.hasAlpha() ? Bitmap.CompressFormat.PNG : Bitmap.CompressFormat.JPEG;
    }

    @Override // m6.InterfaceC3975j
    public EnumC3968c b(C3972g c3972g) {
        return EnumC3968c.TRANSFORMED;
    }
    ...
    */
    public boolean a(o6.InterfaceC4139c<android.graphics.Bitmap> r8, java.io.File r9, m6.C3972g r10) {
        /*
            r7 = this;
            ...
            I6.b.d(r4, r2, r3, r1)
            long r2 = H6.g.b()     // Catch: java.lang.Throwable -> L56
            m6.f<java.lang.Integer> r4 = com.bumptech.glide.load.resource.bitmap.C2424c.f33318b     // Catch: java.lang.Throwable -> L56
            ...
            p6.b r9 = r7.f33320a     // Catch: java.lang.Throwable -> L44 java.io.IOException -> L48
            if (r9 == 0) goto L4b
            ...
            p6.b r5 = r7.f33320a     // Catch: java.lang.Throwable -> L44 java.io.IOException -> L48
        ...
        L6f:
            ...
            r4.append(r1)     // Catch: java.lang.Throwable -> L56
            int r1 = H6.l.h(r8)     // Catch: java.lang.Throwable -> L56
            r4.append(r1)     // Catch: java.lang.Throwable -> L56
            java.lang.String r1 = " in "
            r4.append(r1)     // Catch: java.lang.Throwable -> L56
            double r1 = H6.g.a(r2)     // Catch: java.lang.Throwable -> L56
            r4.append(r1)     // Catch: java.lang.Throwable -> L56
            java.lang.String r1 = ", options format: "
            r4.append(r1)     // Catch: java.lang.Throwable -> L56
            m6.f<android.graphics.Bitmap$CompressFormat> r1 = com.bumptech.glide.load.resource.bitmap.C2424c.f33319c     // Catch: java.lang.Throwable -> L56
        ...
        Lc6:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.load.resource.bitmap.C2424c.a(o6.c, java.io.File, m6.g):boolean");
    }
}
