    ...
    public Object[] deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        while (true) {
            try {
                ...
                Object nullValue = jsonTokenNextToken == JsonToken.VALUE_NULL ? this._elementDeserializer.getNullValue(deserializationContext) : typeDeserializer == null ? this._elementDeserializer.deserialize(jsonParser, deserializationContext) : this._elementDeserializer.deserializeWithType(jsonParser, deserializationContext, typeDeserializer);
                ...
                int i3 = i2 + 1;
                try {
                    objArrResetAndStart[i2] = nullValue;
                    i2 = i3;
                } catch (Exception e2) {
                    e = e2;
                    i2 = i3;
