...
final class C6375j0 implements InterfaceC6379l0 {

    /* renamed from: a */
    private final /* synthetic */ zacp f17420a;

    C6375j0(zacp zacpVar) {
        this.f17420a = zacpVar;
    }
    ...
    public final void mo14063a(BasePendingResult<?> basePendingResult) {
        this.f17420a.f17576c.remove(basePendingResult);
    }
}
