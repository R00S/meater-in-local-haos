...
final class C6857kg implements zzbam<zzp, Bitmap> {
    ...
    C6857kg(zzcan zzcanVar, double d2, boolean z) {
    ...
    public final /* synthetic */ Bitmap mo14764a(zzp zzpVar) {
        return this.f19701c.m18619b(zzpVar.f26740b, this.f19699a, this.f19700b);
    }
}
