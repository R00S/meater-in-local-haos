...
public abstract class zzaiu extends zzfn implements zzait {
    /* renamed from: h7 */
    public static zzait m16592h7(IBinder iBinder) {
        if (iBinder == null) {
            return null;
        }
        ...
        return iInterfaceQueryLocalInterface instanceof zzait ? (zzait) iInterfaceQueryLocalInterface : new zzaiv(iBinder);
    }
