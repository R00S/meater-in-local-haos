...
public class c {
    ...
    private static final ThreadLocal<Matrix> f36747a = new ThreadLocal<>();

    /* renamed from: b, reason: collision with root package name */
    private static final ThreadLocal<RectF> f36748b = new ThreadLocal<>();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal<Matrix> threadLocal = f36747a;
        ...
        ThreadLocal<RectF> threadLocal2 = f36748b;
