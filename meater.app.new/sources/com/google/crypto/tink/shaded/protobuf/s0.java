...
interface s0 {
    ...
    void I(int i10, List<AbstractC2898h> list);

    void J(int i10, Object obj, f0 f0Var);

    <K, V> void K(int i10, I.a<K, V> aVar, Map<K, V> map);

    @Deprecated
    void L(int i10, Object obj, f0 f0Var);

    @Deprecated
    void M(int i10, List<?> list, f0 f0Var);

    void N(int i10, List<?> list, f0 f0Var);

    void O(int i10, AbstractC2898h abstractC2898h);
