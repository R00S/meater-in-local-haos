...
public final /* data */ class SessionDetails {
    ...
    public boolean equals(Object other) {
        ...
        return C9801m.m32341a(this.sessionId, sessionDetails.sessionId) && C9801m.m32341a(this.firstSessionId, sessionDetails.firstSessionId) && this.sessionIndex == sessionDetails.sessionIndex && this.sessionStartTimestampUs == sessionDetails.sessionStartTimestampUs;
    }

    public int hashCode() {
        return (((((this.sessionId.hashCode() * 31) + this.firstSessionId.hashCode()) * 31) + this.sessionIndex) * 31) + C1152a.m6829a(this.sessionStartTimestampUs);
    }
