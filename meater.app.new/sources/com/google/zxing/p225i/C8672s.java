...
public final class C8672s extends AbstractC8670q {
    ...
    public C8637b mo27243a(String str, EnumC8620a enumC8620a, int i2, int i3, Map<EnumC8622c, ?> map) throws WriterException {
        if (enumC8620a == EnumC8620a.UPC_E) {
            return super.mo27243a(str, enumC8620a, i2, i3, map);
        }
        throw new IllegalArgumentException("Can only encode UPC_E, but got ".concat(String.valueOf(enumC8620a)));
    }
    ...
    public boolean[] mo27380c(String str) {
        ...
        if (length == 7) {
            try {
                str = str + AbstractC8669p.m27392b(C8671r.m27393c(str));
        ...
        int i2 = C8671r.f32890g[iDigit][Character.digit(str.charAt(7), 10)];
        ...
        for (int i3 = 1; i3 <= 6; i3++) {
            ...
            iM27388b += AbstractC8667n.m27388b(zArr, iM27388b, AbstractC8669p.f32888e[iDigit2], false);
        }
        AbstractC8667n.m27388b(zArr, iM27388b, AbstractC8669p.f32886c, false);
        return zArr;
    }
}
