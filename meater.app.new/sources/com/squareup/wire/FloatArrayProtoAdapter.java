...
public final class FloatArrayProtoAdapter extends ProtoAdapter<float[]> {
    ...
    public FloatArrayProtoAdapter(ProtoAdapter<Float> originalAdapter) {
        super(FieldEncoding.LENGTH_DELIMITED, (d<?>) P.b(float[].class), (String) null, originalAdapter.getSyntax(), new float[0]);
    ...
    public int encodedSize(float[] value) {
        ...
        int iEncodedSize = 0;
        for (float f10 : value) {
            iEncodedSize += this.originalAdapter.encodedSize(Float.valueOf(f10));
        }
        return iEncodedSize;
    }
    ...
    public void encode(ProtoWriter writer, float[] value) {
        ...
        C3862t.g(value, "value");
        for (float f10 : value) {
            this.originalAdapter.encode(writer, (ProtoWriter) Float.valueOf(f10));
        }
    }
