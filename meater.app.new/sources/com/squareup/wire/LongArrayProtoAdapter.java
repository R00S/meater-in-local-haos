...
public final class LongArrayProtoAdapter extends ProtoAdapter<long[]> {
    ...
    public LongArrayProtoAdapter(ProtoAdapter<Long> originalAdapter) {
        super(FieldEncoding.LENGTH_DELIMITED, (d<?>) P.b(long[].class), (String) null, originalAdapter.getSyntax(), new long[0]);
    ...
    public int encodedSize(long[] value) {
        ...
        int iEncodedSize = 0;
        for (long j10 : value) {
            iEncodedSize += this.originalAdapter.encodedSize(Long.valueOf(j10));
        }
        return iEncodedSize;
    }
    ...
    public void encode(ProtoWriter writer, long[] value) {
        ...
        C3862t.g(value, "value");
        for (long j10 : value) {
            this.originalAdapter.encode(writer, (ProtoWriter) Long.valueOf(j10));
        }
    }
