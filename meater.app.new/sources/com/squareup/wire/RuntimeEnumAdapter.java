...
public final class RuntimeEnumAdapter<E extends WireEnum> extends EnumAdapter<E> {
    ...
    public RuntimeEnumAdapter(Class<E> javaType, Syntax syntax) {
        super((d<WireEnum>) a.e(javaType), syntax, Internal.getIdentityOrNull(javaType));
        C3862t.g(javaType, "javaType");
    ...
    private final Method getFromValueMethod() throws NoSuchMethodException, SecurityException {
        ...
        C3862t.f(method2, "also(...)");
        return method2;
    }

    public boolean equals(Object other) {
        return (other instanceof RuntimeEnumAdapter) && C3862t.b(((RuntimeEnumAdapter) other).getType(), getType());
    }
    ...
    protected E fromValue(int value) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        C3862t.e(objInvoke, "null cannot be cast to non-null type E of com.squareup.wire.RuntimeEnumAdapter");
        return (E) objInvoke;
    }
