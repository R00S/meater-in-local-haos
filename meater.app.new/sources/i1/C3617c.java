...
public final class C3617c {
    ...
    private static final ThreadLocal<TypedValue> f42996a = new ThreadLocal<>();
    ...
    private static TypedValue c() {
        ThreadLocal<TypedValue> threadLocal = f42996a;
    ...
    */
    private static android.content.res.ColorStateList e(android.content.res.Resources r17, org.xmlpull.v1.XmlPullParser r18, android.util.AttributeSet r19, android.content.res.Resources.Theme r20) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: i1.C3617c.e(android.content.res.Resources, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet, android.content.res.Resources$Theme):android.content.res.ColorStateList");
    }
    ...
    private static int g(int i10, float f10, float f11) {
        ...
        int iB = C3946a.b((int) ((Color.alpha(i10) * f10) + 0.5f), 0, 255);
        if (z10) {
            C3615a c3615aC = C3615a.c(i10);
            i10 = C3615a.m(c3615aC.j(), c3615aC.i(), f11);
        }
