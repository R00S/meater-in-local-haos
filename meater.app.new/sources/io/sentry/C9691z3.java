...
public final class C9691z3 implements InterfaceC9679x3 {

    /* renamed from: a */
    private final InterfaceC9660v3 f37027a;

    public C9691z3(InterfaceC9660v3 interfaceC9660v3) {
        this.f37027a = (InterfaceC9660v3) C9646q.m31802c(interfaceC9660v3, "SendFireAndForgetDirPath is required");
    }
    ...
    public InterfaceC9627u3 mo31941b(InterfaceC9658v1 interfaceC9658v1, C9680x4 c9680x4) {
        ...
        String strMo30388a = this.f37027a.mo30388a();
        if (strMo30388a != null && mo31942c(strMo30388a, c9680x4.getLogger())) {
            return mo31940a(new C9491j3(interfaceC9658v1, c9680x4.getEnvelopeReader(), c9680x4.getSerializer(), c9680x4.getLogger(), c9680x4.getFlushTimeoutMillis()), strMo30388a, c9680x4.getLogger());
        }
        c9680x4.getLogger().mo30214c(EnumC9587s4.ERROR, "No outbox dir path is defined in options.", new Object[0]);
        return null;
    }
