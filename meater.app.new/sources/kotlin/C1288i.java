...
@Metadata(d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0010\b\n\u0002\b\u0007\b\u0007\u0018\u00002\u00020\u0001B1\b\u0000\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0004\u001a\u00020\u0002\u0012\u0006\u0010\u0005\u001a\u00020\u0002\u0012\u0006\u0010\u0006\u001a\u00020\u0002\u0012\u0006\u0010\u0007\u001a\u00020\u0002¢\u0006\u0004\b\b\u0010\tJ%\u0010\u000f\u001a\b\u0012\u0004\u0012\u00020\u00020\u000e2\u0006\u0010\u000b\u001a\u00020\n2\u0006\u0010\r\u001a\u00020\fH\u0003¢\u0006\u0004\b\u000f\u0010\u0010J%\u0010\u0011\u001a\b\u0012\u0004\u0012\u00020\u00020\u000e2\u0006\u0010\u000b\u001a\u00020\n2\u0006\u0010\r\u001a\u00020\fH\u0001¢\u0006\u0004\b\u0011\u0010\u0010J\u001a\u0010\u0013\u001a\u00020\n2\b\u0010\u0012\u001a\u0004\u0018\u00010\u0001H\u0096\u0002¢\u0006\u0004\b\u0013\u0010\u0014J\u000f\u0010\u0016\u001a\u00020\u0015H\u0016¢\u0006\u0004\b\u0016\u0010\u0017R\u001a\u0010\u0003\u001a\u00020\u00028\u0002X\u0082\u0004ø\u0001\u0000ø\u0001\u0001¢\u0006\u0006\n\u0004\b\u0018\u0010\u0019R\u001a\u0010\u0004\u001a\u00020\u00028\u0002X\u0082\u0004ø\u0001\u0000ø\u0001\u0001¢\u0006\u0006\n\u0004\b\u001a\u0010\u0019R\u001a\u0010\u0005\u001a\u00020\u00028\u0002X\u0082\u0004ø\u0001\u0000ø\u0001\u0001¢\u0006\u0006\n\u0004\b\u001b\u0010\u0019R\u001a\u0010\u0006\u001a\u00020\u00028\u0002X\u0082\u0004ø\u0001\u0000ø\u0001\u0001¢\u0006\u0006\n\u0004\b\u000f\u0010\u0019R\u001a\u0010\u0007\u001a\u00020\u00028\u0002X\u0082\u0004ø\u0001\u0000ø\u0001\u0001¢\u0006\u0006\n\u0004\b\u0011\u0010\u0019\u0082\u0002\u000b\n\u0005\b¡\u001e0\u0001\n\u0002\b!¨\u0006\u001c"}, d2 = {"LK/i;", "", "LU0/h;", "defaultElevation", "pressedElevation", "focusedElevation", "hoveredElevation", "disabledElevation", "<init>", "(FFFFFLkotlin/jvm/internal/k;)V", "", "enabled", "Lz/i;", "interactionSource", "LO/x1;", "d", "(ZLz/i;LO/l;I)LO/x1;", "e", "other", "equals", "(Ljava/lang/Object;)Z", "", "hashCode", "()I", "a", "F", "b", "c", "material3_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
...
public final class C1288i {
    ...
    static final class a extends l implements p<I, InterfaceC4588d<? super C4153F>, Object> {
        ...
        final /* synthetic */ InterfaceC5160i f8431C;

        /* renamed from: D, reason: collision with root package name */
        final /* synthetic */ SnapshotStateList<InterfaceC5159h> f8432D;
        ...
        static final class C0164a<T> implements InterfaceC1971f {

            /* renamed from: B, reason: collision with root package name */
            final /* synthetic */ SnapshotStateList<InterfaceC5159h> f8433B;

            C0164a(SnapshotStateList<InterfaceC5159h> snapshotStateList) {
                this.f8433B = snapshotStateList;
            }
        ...
        a(InterfaceC5160i interfaceC5160i, SnapshotStateList<InterfaceC5159h> snapshotStateList, InterfaceC4588d<? super a> interfaceC4588d) {
            ...
            this.f8431C = interfaceC5160i;
            this.f8432D = snapshotStateList;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final InterfaceC4588d<C4153F> create(Object obj, InterfaceC4588d<?> interfaceC4588d) {
            return new a(this.f8431C, this.f8432D, interfaceC4588d);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 == 0) {
                C4173r.b(obj);
                InterfaceC1970e<InterfaceC5159h> interfaceC1970eB = this.f8431C.b();
                C0164a c0164a = new C0164a(this.f8432D);
                this.f8430B = 1;
                if (interfaceC1970eB.b(c0164a, this) == objE) {
                    return objE;
                }
            } else {
                if (i10 != 1) {
    ...
    static final class b extends l implements p<I, InterfaceC4588d<? super C4153F>, Object> {
        ...
        /* renamed from: C, reason: collision with root package name */
        final /* synthetic */ C4737a<h, C4761m> f8435C;

        /* renamed from: D, reason: collision with root package name */
        final /* synthetic */ float f8436D;

        /* renamed from: E, reason: collision with root package name */
        final /* synthetic */ boolean f8437E;

        /* renamed from: F, reason: collision with root package name */
        final /* synthetic */ C1288i f8438F;

        /* renamed from: G, reason: collision with root package name */
        final /* synthetic */ InterfaceC5159h f8439G;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(C4737a<h, C4761m> c4737a, float f10, boolean z10, C1288i c1288i, InterfaceC5159h interfaceC5159h, InterfaceC4588d<? super b> interfaceC4588d) {
            super(2, interfaceC4588d);
            this.f8435C = c4737a;
            this.f8436D = f10;
            this.f8437E = z10;
            this.f8438F = c1288i;
            this.f8439G = interfaceC5159h;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final InterfaceC4588d<C4153F> create(Object obj, InterfaceC4588d<?> interfaceC4588d) {
            return new b(this.f8435C, this.f8436D, this.f8437E, this.f8438F, this.f8439G, interfaceC4588d);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 == 0) {
                C4173r.b(obj);
                if (!h.w(this.f8435C.k().getValue(), this.f8436D)) {
                    if (this.f8437E) {
                        float value = this.f8435C.k().getValue();
                        InterfaceC5159h c5155d = null;
                        if (h.w(value, this.f8438F.pressedElevation)) {
                            c5155d = new m.b(C3476g.INSTANCE.c(), null);
                        } else if (h.w(value, this.f8438F.hoveredElevation)) {
                            c5155d = new C5157f();
                        } else if (h.w(value, this.f8438F.focusedElevation)) {
                            c5155d = new C5155d();
                        }
                        C4737a<h, C4761m> c4737a = this.f8435C;
                        float f10 = this.f8436D;
                        InterfaceC5159h interfaceC5159h = this.f8439G;
                        this.f8434B = 2;
                        if (L.f.d(c4737a, f10, c5155d, interfaceC5159h, this) == objE) {
                            return objE;
                        }
                    } else {
                        C4737a<h, C4761m> c4737a2 = this.f8435C;
                        h hVarP = h.p(this.f8436D);
                        this.f8434B = 1;
    ...
    public /* synthetic */ C1288i(float f10, float f11, float f12, float f13, float f14, C3854k c3854k) {
        this(f10, f11, f12, f13, f14);
    }

    private final x1<h> d(boolean z10, InterfaceC5160i interfaceC5160i, InterfaceC1554l interfaceC1554l, int i10) {
        if (C1560o.J()) {
            C1560o.S(-1312510462, i10, -1, "androidx.compose.material3.ButtonElevation.animateElevation (Button.kt:938)");
        }
    ...
    public final x1<h> e(boolean z10, InterfaceC5160i interfaceC5160i, InterfaceC1554l interfaceC1554l, int i10) {
        if (C1560o.J()) {
            C1560o.S(-2045116089, i10, -1, "androidx.compose.material3.ButtonElevation.shadowElevation (Button.kt:930)");
        }
        x1<h> x1VarD = d(z10, interfaceC5160i, interfaceC1554l, i10 & 1022);
        if (C1560o.J()) {
            C1560o.R();
        }
        return x1VarD;
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof C1288i)) {
            return false;
        }
        C1288i c1288i = (C1288i) other;
        return h.w(this.defaultElevation, c1288i.defaultElevation) && h.w(this.pressedElevation, c1288i.pressedElevation) && h.w(this.focusedElevation, c1288i.focusedElevation) && h.w(this.hoveredElevation, c1288i.hoveredElevation) && h.w(this.disabledElevation, c1288i.disabledElevation);
    }
    ...
    private C1288i(float f10, float f11, float f12, float f13, float f14) {
