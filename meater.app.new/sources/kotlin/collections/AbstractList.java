...
public abstract class AbstractList<E> extends AbstractCollection<E> implements List<E>, KMappedMarker {
    ...
    public static final class a {
        ...
        public final boolean m38561d(Collection<?> collection, Collection<?> collection2) {
            C9801m.m32346f(collection, "c");
            C9801m.m32346f(collection2, "other");
            ...
            while (it2.hasNext()) {
                if (!C9801m.m32341a(it2.next(), it.next())) {
                    return false;
                }
            }
            return true;
    ...
    private static final class d<E> extends AbstractList<E> implements RandomAccess {
        ...
        public d(AbstractList<? extends E> abstractList, int i2, int i3) {
            C9801m.m32346f(abstractList, "list");
    ...
    public int lastIndexOf(E element) {
        ...
        while (listIterator.hasPrevious()) {
            if (C9801m.m32341a(listIterator.previous(), element)) {
