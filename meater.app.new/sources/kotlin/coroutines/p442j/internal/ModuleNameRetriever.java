...
final class ModuleNameRetriever {
    ...
    public final String m39062b(BaseContinuationImpl baseContinuationImpl) {
        C9801m.m32346f(baseContinuationImpl, "continuation");
        a aVarM39061a = f41545c;
        if (aVarM39061a == null) {
            aVarM39061a = m39061a(baseContinuationImpl);
        }
        if (aVarM39061a == f41544b) {
            return null;
        }
        Method method = aVarM39061a.f41546a;
        Object objInvoke = method != null ? method.invoke(baseContinuationImpl.getClass(), new Object[0]) : null;
        if (objInvoke == null) {
            return null;
        }
        Method method2 = aVarM39061a.f41547b;
        Object objInvoke2 = method2 != null ? method2.invoke(objInvoke, new Object[0]) : null;
        if (objInvoke2 == null) {
            return null;
        }
        Method method3 = aVarM39061a.f41548c;
