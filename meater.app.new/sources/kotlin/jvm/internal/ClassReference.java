...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
            ...
            if (!cls.isAnonymousClass()) {
                if (cls.isLocalClass()) {
                    ...
                    if (enclosingMethod != null) {
                        ...
                        String strM37533G0 = C10547v.m37533G0(simpleName, enclosingMethod.getName() + '$', null, 2, null);
                        if (strM37533G0 != null) {
                            return strM37533G0;
                        }
                    }
    ...
    static {
        int i2 = 0;
        List listM38891m = C10817u.m38891m(Function0.class, Function1.class, Function2.class, Function3.class, Function4.class, Function5.class, Function6.class, Function7.class, Function8.class, Function9.class, Function10.class, Function11.class, Function12.class, Function13.class, Function14.class, Function15.class, Function16.class, Function17.class, Function18.class, Function19.class, Function20.class, Function21.class, Function22.class);
        ArrayList arrayList = new ArrayList(C10819v.m38911u(listM38891m, 10));
        for (Object obj : listM38891m) {
            int i3 = i2 + 1;
            if (i2 < 0) {
                C10817u.m38898t();
            }
            arrayList.add(C10773s.m38547a((Class) obj, Integer.valueOf(i2)));
            i2 = i3;
        }
        f37171g = C10810q0.m38805q(arrayList);
        ...
        C9801m.m32345e(collectionValues, "primitiveFqNames.values");
        for (String str : collectionValues) {
            StringBuilder sb = new StringBuilder();
            sb.append("kotlin.jvm.internal.");
            C9801m.m32345e(str, "kotlinName");
            sb.append(C10547v.m37537I0(str, '.', null, 2, null));
            sb.append("CompanionObject");
            Pair pairM38547a = C10773s.m38547a(sb.toString(), str + ".Companion");
            map3.put(pairM38547a.m37648c(), pairM38547a.m37649d());
        }
        ...
        f37174j = map3;
        LinkedHashMap linkedHashMap = new LinkedHashMap(C10808p0.m38793e(map3.size()));
        for (Map.Entry entry2 : map3.entrySet()) {
            linkedHashMap.put(entry2.getKey(), C10547v.m37537I0((String) entry2.getValue(), '.', null, 2, null));
        }
    ...
    public boolean equals(Object other) {
        return (other instanceof ClassReference) && C9801m.m32341a(C9752a.m32277c(this), C9752a.m32277c((KClass) other));
    }
