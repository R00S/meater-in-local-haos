...
final class TypeVariableImpl implements TypeVariable<GenericDeclaration>, Type {
    ...
    public boolean equals(Object other) {
        if (other instanceof TypeVariable) {
            ...
            if (C9801m.m32341a(getName(), typeVariable.getName()) && C9801m.m32341a(getGenericDeclaration(), typeVariable.getGenericDeclaration())) {
                return true;
            }
        }
        return false;
    ...
    public Type[] getBounds() {
        ...
        while (it.hasNext()) {
            arrayList.add(C9872w.m32453c((KType) it.next(), true));
        }
