...
public final class C10572a {
    ...
    /* renamed from: b */
    public static final <T> KFunction<T> m37663b(KClass<T> kClass) {
        T next;
        C9801m.m32346f(kClass, "<this>");
        Iterator<T> it = ((KClassImpl) kClass).m32579P().iterator();
        while (true) {
            if (!it.hasNext()) {
                next = null;
                break;
            ...
            C9801m.m32344d(kFunction, "null cannot be cast to non-null type kotlin.reflect.jvm.internal.KFunctionImpl");
            InterfaceC10738y interfaceC10738yMo37304F = ((KFunctionImpl) kFunction).mo37304F();
            C9801m.m32344d(interfaceC10738yMo37304F, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.ConstructorDescriptor");
            if (((InterfaceC10606l) interfaceC10738yMo37304F).mo37713B()) {
                break;
            }
        }
    ...
    /* renamed from: c */
    private static final boolean m37664c(KCallableImpl<?> kCallableImpl) {
        return kCallableImpl.mo37304F().mo37032m0() != null;
    }

    /* renamed from: d */
    private static final boolean m37665d(KCallableImpl<?> kCallableImpl) {
        return !m37664c(kCallableImpl);
    }
}
