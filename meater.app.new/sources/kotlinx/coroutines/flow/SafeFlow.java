...
final class SafeFlow<T> extends AbstractFlow<T> {
    ...
    /* renamed from: f */
    private final Function2<FlowCollector<? super T>, Continuation<? super C10775u>, Object> f41939f;

    /* JADX WARN: Multi-variable type inference failed */
    public SafeFlow(Function2<? super FlowCollector<? super T>, ? super Continuation<? super C10775u>, ? extends Object> function2) {
        this.f41939f = function2;
    }

    @Override // kotlinx.coroutines.flow.AbstractFlow
    /* renamed from: b */
    public Object mo39718b(FlowCollector<? super T> flowCollector, Continuation<? super C10775u> continuation) {
        Object objInvoke = this.f41939f.invoke(flowCollector, continuation);
        return objInvoke == C10855d.m39045c() ? objInvoke : C10775u.f41439a;
    }
}
