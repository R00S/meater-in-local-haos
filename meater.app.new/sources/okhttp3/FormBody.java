...
public final class FormBody extends RequestBody {
    ...
    public FormBody(List<String> list, List<String> list2) {
        C9801m.m32346f(list, "encodedNames");
        C9801m.m32346f(list2, "encodedValues");
        this.encodedNames = Util.toImmutableList(list);
        this.encodedValues = Util.toImmutableList(list2);
    }

    private final long writeOrCountBytes(InterfaceC9705g sink, boolean countBytes) throws EOFException {
        C9703f c9703fMo32042i;
        if (countBytes) {
            c9703fMo32042i = new C9703f();
        } else {
            C9801m.m32343c(sink);
            c9703fMo32042i = sink.mo32042i();
        }
        int size = this.encodedNames.size();
        for (int i2 = 0; i2 < size; i2++) {
            if (i2 > 0) {
                c9703fMo32042i.writeByte(38);
            }
            c9703fMo32042i.mo32055r0(this.encodedNames.get(i2));
            c9703fMo32042i.writeByte(61);
            c9703fMo32042i.mo32055r0(this.encodedValues.get(i2));
        }
        if (!countBytes) {
            return 0L;
        }
        long size2 = c9703fMo32042i.size();
        c9703fMo32042i.m32030b();
        return size2;
    }
    ...
    public static final class Builder {
        ...
        public /* synthetic */ Builder(Charset charset, int i2, C9789g c9789g) {
