...
public class C8944a extends AppCompatRadioButton {

    /* renamed from: i */
    private static final int f34419i = C8917k.f33996u;
    ...
    public C8944a(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C8908b.f33835y);
    }

    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.f34421k == null) {
            int iM28472c = C8937a.m28472c(this, C8908b.f33820j);
            int iM28472c2 = C8937a.m28472c(this, C8908b.f33822l);
            int iM28472c3 = C8937a.m28472c(this, C8908b.f33825o);
            int[][] iArr = f34420j;
            int[] iArr2 = new int[iArr.length];
            iArr2[0] = C8937a.m28475f(iM28472c3, iM28472c, 1.0f);
            iArr2[1] = C8937a.m28475f(iM28472c3, iM28472c2, 0.54f);
            iArr2[2] = C8937a.m28475f(iM28472c3, iM28472c2, 0.38f);
            iArr2[3] = C8937a.m28475f(iM28472c3, iM28472c2, 0.38f);
    ...
    public C8944a(Context context, AttributeSet attributeSet, int i2) {
        int i3 = f34419i;
        super(C8079a.m24906c(context, attributeSet, i2, i3), attributeSet, i2);
        Context context2 = getContext();
        TypedArray typedArrayM24694h = C8032j.m24694h(context2, attributeSet, C8918l.f34325t3, i2, i3, new int[0]);
        int i4 = C8918l.f34332u3;
        if (typedArrayM24694h.hasValue(i4)) {
            C0324e.m2308c(this, C8947c.m28499a(context2, typedArrayM24694h, i4));
        }
        this.f34422l = typedArrayM24694h.getBoolean(C8918l.f34339v3, false);
