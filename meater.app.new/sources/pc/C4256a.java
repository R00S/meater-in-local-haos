...
public final class C4256a {
    private static final boolean a(String str) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            ...
            if (C3862t.i(cCharAt, 31) <= 0 || C3862t.i(cCharAt, 127) >= 0 || n.X(" #%/:?@[\\]", cCharAt, 0, false, 6, null) != -1) {
                return true;
            }
        }
        return false;
    ...
    private static final boolean b(String str, int i10, int i11, byte[] bArr, int i12) {
        ...
        while (i10 < i11) {
            ...
            while (i14 < i11) {
                ...
                if (C3862t.i(cCharAt, 48) < 0 || C3862t.i(cCharAt, 57) > 0) {
                    break;
                }
    ...
    */
    private static final java.net.InetAddress c(java.lang.String r18, int r19, int r20) {
        ...
        L15:
            ...
            r10 = r5
            r5 = r17
            boolean r0 = Ub.n.F(r0, r1, r2, r3, r4, r5)
            if (r0 == 0) goto L38
            if (r14 == r11) goto L2e
            return r16
        L2e:
        ...
        La8:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: pc.C4256a.c(java.lang.String, int, int):java.net.InetAddress");
    }
    ...
    private static final String d(byte[] bArr) {
        ...
        while (i11 < bArr.length) {
            if (i11 == i10) {
                ...
                c0982e.K0((d.d(bArr[i11], 255) << 8) | d.d(bArr[i11 + 1], 255));
                i11 += 2;
            }
        }
        return c0982e.Q();
    ...
    public static final String e(String str) {
        ...
        InetAddress inetAddressC = (n.G(str, "[", false, 2, null) && n.s(str, "]", false, 2, null)) ? c(str, 1, str.length() - 1) : c(str, 0, str.length());
        if (inetAddressC == null) {
            return null;
        }
        byte[] address = inetAddressC.getAddress();
        if (address.length == 16) {
            C3862t.f(address, "address");
            return d(address);
        }
        if (address.length == 4) {
