...
final class OkHttpCall<T> implements Call<T> {
    ...
    static final class ExceptionCatchingResponseBody extends ResponseBody {
        ...
        private final InterfaceC9709h delegateSource;
        IOException thrownException;

        ExceptionCatchingResponseBody(ResponseBody responseBody) {
            this.delegate = responseBody;
            this.delegateSource = C9718q.m32120d(new AbstractC9713l(responseBody.getBodySource()) { // from class: retrofit2.OkHttpCall.ExceptionCatchingResponseBody.1
                @Override // p353j.AbstractC9713l, p353j.InterfaceC9700d0
                public long read(C9703f c9703f, long j2) throws IOException {
                    try {
                        return super.read(c9703f, j2);
        ...
        @Override // okhttp3.ResponseBody
        /* renamed from: source */
        public InterfaceC9709h getBodySource() {
    ...
    public void enqueue(final Callback<T> callback) {
        okhttp3.Call call;
        Throwable th;
        C11219c.m39905a(callback, "callback == null");
        synchronized (this) {
            if (this.executed) {
    ...
    @Override // retrofit2.Call
    public synchronized C9702e0 timeout() {
        try {
        } catch (IOException e2) {
