...
public final class ProbeCharacteristicValueUpdatedMessage extends Message<ProbeCharacteristicValueUpdatedMessage, Builder> {
    ...
    public static final class Builder extends Message.Builder<ProbeCharacteristicValueUpdatedMessage, Builder> {
        ...
        public ProbeCharacteristicValueUpdatedMessage m321build() {
    ...
    private static final class ProtoAdapter_ProbeCharacteristicValueUpdatedMessage extends ProtoAdapter<ProbeCharacteristicValueUpdatedMessage> {
        ...
        public ProbeCharacteristicValueUpdatedMessage m322decode(ProtoReader protoReader) {
        ...
        public ProbeCharacteristicValueUpdatedMessage redact(ProbeCharacteristicValueUpdatedMessage probeCharacteristicValueUpdatedMessage) {
            Builder m320newBuilder = probeCharacteristicValueUpdatedMessage.m320newBuilder();
            ProbeSimulatorHeader probeSimulatorHeader = m320newBuilder.header;
            if (probeSimulatorHeader != null) {
                m320newBuilder.header = (ProbeSimulatorHeader) ProbeSimulatorHeader.ADAPTER.redact(probeSimulatorHeader);
            }
            m320newBuilder.clearUnknownFields();
            return m320newBuilder.m321build();
        }
    }
    ...
    public String toString() {
        ...
        StringBuilder replace = sb.replace(0, 2, "ProbeCharacteristicValueUpdatedMessage{");
        replace.append('}');
